...
//var_dump($con);
	   $sql="select * from v9_fujing_202304 "; //从4月同步到5月，4月已经做过矫正
...
*/
		 ...
		 //$tmp=$row[10].$row[11];
		 $sql2="update v9_fujing set password=".$row['password'].",gwdj=".$row['gwdj'].",cengji2=".$row['cengji'].",cj3='".$row['cj3']."',dc='".$row['dc']."',gw='".$row['gw']."',pingdangtime=".$row['pingdangtime'].",pingjitime=".$row['pingjitime'].",kz_zhiban=".$row['kz_zhiban'].",kz_jixiao=".$row['kz_jixiao'].",kz_niangong=".$row['kz_niangong']."  where id='".$row['id']."' ";
		 echo $sql2."<br>";
