...
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		<td width="15%" height="37"><strong>家属姓名：</strong></td>
		<td width="40%"><input type="input" name="info[xingming]"  style="width:200px;" /></td>
		<td width="15%"><strong>性别：</strong></td>
		<td width="40%"><?php echo form::select(array('男'=>'男','女'=>'女'),'男','name=info[sex]  class=infoselect')?></td>
	</tr>
	<tr>
		<td width="" height="37"><strong>身份证：</strong></td>
		<td width=""><input type="input" name="info[sfz]"  style="width:200px;" /></td>
		<td width=""><strong>住址：</strong></td>
		<td width=""><input type="input" name="info[dizhi]"  style="width:200px;"/></td>
	</tr>
	<tr>
		<td width="" height="37"><strong>电话：</strong></td>
		<td width=""><input type="input" name="info[tel]"  style="width:200px;"/></td>
	...
	<tr>
		...
		<td width=""><input type="input" name="info[gzdw]"  style="width:200px;" /></td>
