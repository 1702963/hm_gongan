        	...
        	<tr>
                ...
                <td width="248">任务类型：
                    <select name="dwid">
                        ...
                        <option value="">单次运行</option>
                        <option value="">定时循环</option>
                        <option value="">条件触发</option>
                        <option value="">扩展任务</option>    
					</select>
                </td>
                <td width="283">任务状态：
					<select name="sex">
						<option value="">不限</option>
						<option value="男" <?php if($sex=="男"){?>selected="selected"<?php }?>>启用</option>
						<option value="女" <?php if($sex=="女"){?>selected="selected"<?php }?>>禁用</option>
					</select>
                </td>
                <td width="406">创建时间：
					<select name="rjtj">
...
<table width="100%" cellspacing="4" cellpadding="4" class="kotable">
	...
	<tr>
      ...
      <th width="195">任务名称</th>
	  <th width='169'>任务类型</th>
	   <th width="171">任务状态</th>
      <th width="205">创建日期</th>
	  <th width="228">前次运行时间</th>
      <th width="391">任务参数</th>
      <th width="307">操作</th>
	</tr>
    </thead>
    <tbody>
