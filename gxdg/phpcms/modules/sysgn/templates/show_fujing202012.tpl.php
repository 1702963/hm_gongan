...
<script type="text/javascript">
function jiaoyu(id) {
	window.top.art.dialog({title:'教育培训记录', id:'showme2', iframe:'?m=renshi&c=renshi&a=jiaoyu&id='+id ,width:'800px',height:'500px'});
}
function biaozhang(id) {
	window.top.art.dialog({title:'表彰记录', id:'showme5', iframe:'?m=renshi&c=renshi&a=biaozhang&id='+id ,width:'800px',height:'500px'});
}
function lvli(id) {
	window.top.art.dialog({title:'履历记录', id:'showme6', iframe:'?m=renshi&c=renshi&a=lvli&id='+id ,width:'1000px',height:'500px'});
}
function techang(id) {
	window.top.art.dialog({title:'特长记录', id:'showme7', iframe:'?m=renshi&c=renshi&a=techang&id='+id ,width:'1000px',height:'500px'});
}

function chengjie(id) {
	window.top.art.dialog({title:'惩戒记录', id:'showme5', iframe:'?m=renshi&c=renshi&a=chengjie&id='+id ,width:'800px',height:'500px'});
}
function jiashu(id) {
	window.top.art.dialog({title:'家属列表', id:'showme4', iframe:'?m=renshi&c=renshi&a=jiashu&id='+id ,width:'800px',height:'500px'});
}
function zhuangbei(id) {
	window.top.art.dialog({title:'装备发放记录', id:'showme3', iframe:'?m=renshi&c=renshi&a=zhuangbei&id='+id ,width:'800px',height:'500px'});
}
