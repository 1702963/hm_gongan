    	...
    	<table width="995" border="0">
        	<tr>
                ...
                <td width="246">事项类别：
					<select name="sex">
						<option value="">不限</option>
						<option value="护照">持有护照</option>
						<option value="边境通行证">持有边境通行证</option>    
                        <option value="本人参与盈利情况">本人参与盈利情况</option>
                        <option value="经商办企">经商办企</option>
                        <option value="家庭成员">家庭成员</option>
                        <option value="犯罪违法情况">犯罪违法情况</option>
                        <option value="工资">工资</option>
                        <option value="房产">房产</option>
                        <option value="机动车">机动车</option>
                        <option value="股票">股票</option>
                        <option value="证券基金">证券基金</option>
                        <option value="投资型保险">投资型保险</option>
                        <option value="投资情况">投资情况</option>
					</select>
                </td>
                <td width="339">
