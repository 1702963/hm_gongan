...
<form action="?m=peixunnew&c=hebeiganyuan&a=editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo $this->info['id']?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">编辑河北干院培训计划</div>
  ...
  <tr>
    ...
    <td colspan="5">
      <select name="info[pxly]" id="pxly"
              style="width:300px;height:28px;background:#1a2a4a;color:#fff;border:1px solid #ddd;margin-left:5px;">
        <option value="河北干院" <?php echo $this->info['pxly'] == '河北干院' ? 'selected' : ''?>>河北干院</option>
      </select>
      <span style="color:#999;font-size:12px;margin-left:10px;">固定为"河北干院"</span>
    </td>
  </tr>
