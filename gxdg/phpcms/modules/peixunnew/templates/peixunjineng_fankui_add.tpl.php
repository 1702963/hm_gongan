...
<form action="?m=peixunnew&c=peixunjineng_fankui&a=addsave" method="POST" name="myform" id="myform">

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">警务技能培训反馈</div>
...
$(function(){
    $("#fujing_search").bind("keyup click", function(){
        ...
        $.ajax({
            url: 'index.php?m=peixunnew&c=peixunjineng_fankui&a=searchfujing',
            type: 'POST',
