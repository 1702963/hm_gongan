...
<form action="?m=peixunnew&c=fujingpeixun&a=addsave" method="POST" name="myform" id="myform">

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">辅警培训计划</div>
  ...
  <tr>
    ...
    <td colspan="5">
      <select name="info[pxly]" id="pxly"
              style="width:300px;height:28px;background:#1a2a4a;color:#fff;border:1px solid #ddd;margin-left:5px;">
        <option value="教育训练系统" selected>教育训练系统</option>
      </select>
