...
<form action="?m=peixunnew&c=fujingpeixun_jilu&a=addsave" method="POST" name="myform" id="myform">

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">辅警培训记录</div>
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=peixunnew&c=fujingpeixun_jilu&a=upload_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
$(function(){
    $("#fujing_search").bind("keyup click", function(){
        ...
        $.ajax({
            url: 'index.php?m=peixunnew&c=fujingpeixun_jilu&a=searchfujing',
            type: 'POST',
