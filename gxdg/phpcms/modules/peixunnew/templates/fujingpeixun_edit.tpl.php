...
<form action="?m=peixunnew&c=fujingpeixun&a=editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo $this->info['id']?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">编辑辅警培训计划</div>
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    ...
    <td colspan="5">
      ...
      <span style="color:#999;font-size:12px;margin-left:10px;">等同于警种</span>
    </td>
  </tr>

  <tr>
    <td align="right" class="infotitle">培训来源：</td>
    <td colspan="5">
      <select name="info[pxly]" id="pxly"
              style="width:300px;height:28px;background:#1a2a4a;color:#fff;border:1px solid #ddd;margin-left:5px;">
        <option value="教育训练系统" <?php echo $this->info['pxly'] == '教育训练系统' ? 'selected' : ''?>>教育训练系统</option>
      </select>
      <span style="color:#999;font-size:12px;margin-left:10px;">固定为"教育训练系统"</span>
    </td>
  </tr>
