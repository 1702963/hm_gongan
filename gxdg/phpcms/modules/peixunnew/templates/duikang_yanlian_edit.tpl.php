...
<form action="?m=peixunnew&c=duikang_yanlian&a=editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo $this->info['id']?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">编辑对抗演练</div>
  ...
  <tr>
    ...
    <td colspan="5">
      <textarea name="info[content]" id="content" rows="5"
                ...
                placeholder="请输入对抗演练的具体内容（支持文字、图片、视频描述）"><?php echo htmlspecialchars($this->info['content'])?></textarea>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="5">
      <textarea name="info[pingjia]" id="pingjia" rows="5"
                style="width:600px;background:transparent;color:#fff;border:1px solid #ddd;margin-left:5px;padding:5px"
                placeholder="请输入对抗演练的评价和总结"><?php echo htmlspecialchars($this->info['pingjia'])?></textarea>
    </td>
  </tr>
