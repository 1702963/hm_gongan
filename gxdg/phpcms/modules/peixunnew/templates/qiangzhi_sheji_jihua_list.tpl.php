...
<div class="explain-col">
  快速工具:
<a href="index.php?m=peixunnew&c=qiangzhi_sheji_jihua&a=add"><input type="button" value="添加射击计划" style="margin-left:10px; width:100px" class="doLock" name="dook"></a>
</div>

<div class="search-box">
    <form method="GET" action="index.php">
        <input type="hidden" name="m" value="peixunnew">
        <input type="hidden" name="c" value="qiangzhi_sheji_jihua">
        ...
        <input type="text" name="keyword" value="<?php echo htmlspecialchars($this->keyword)?>" placeholder="射击标题" style="width:150px;">

        <input type="submit" value="搜索" class="doLock" style="margin-left:10px;">
        <a href="index.php?m=peixunnew&c=qiangzhi_sheji_jihua&a=init"><input type="button" value="重置" class="doLock"></a>
    </form>
</div>
...
<table width="100%" cellspacing="4" cellpadding="4" class="kotable">
    ...
    <tr>
      ...
      <th width="200">射击标题</th>
      <th width="100">射击来源</th>
...
if(is_array($this->list)){
    ...
    <tr>
      ...
      <td><?php echo $info['pxly'] ? $info['pxly'] : '内部培训'?></td>
      ...
      <td>
        &nbsp;<a href="index.php?m=peixunnew&c=qiangzhi_sheji_jihua&a=edit&id=<?php echo $info['id']?>">编辑</a>
        &nbsp;<a href="index.php?m=peixunnew&c=qiangzhi_sheji_jihua&a=del&id=<?php echo $info['id']?>" onclick="javascript:var r = confirm('确认删除该记录吗？');if(!r){return false;}">删除</a>
      </td>
    </tr>
   <?php
    $i++;}
