...
// 业务警种培训数量
$_result = $_fj_conn->query("SELECT COUNT(*) as cnt FROM v9_peixun_yewu_jihua");
$_row = $_result->fetch_assoc();
$yewujingzhong = intval($_row['cnt']);

// 业务警种培训人次
$_result = $_fj_conn->query("SELECT COUNT(*) as cnt FROM v9_peixun_yewu_jilu");
$_row = $_result->fetch_assoc();
$yewujingzhong_count = intval($_row['cnt']);

// 辅警培训数量
$_result = $_fj_conn->query("SELECT COUNT(*) as cnt FROM v9_peixun_fujing_jihua");
$_row = $_result->fetch_assoc();
$fujing = intval($_row['cnt']);

// 辅警培训人次
$_result = $_fj_conn->query("SELECT COUNT(*) as cnt FROM v9_peixun_fujing_jilu");
$_row = $_result->fetch_assoc();
$fujing_count = intval($_row['cnt']);

// 专业培训数量
$_result = $_fj_conn->query("SELECT COUNT(*) as cnt FROM v9_peixun_zhuanye_jihua");
$_row = $_result->fetch_assoc();
$zhuanye = intval($_row['cnt']);

// 专业培训人次
$_result = $_fj_conn->query("SELECT COUNT(*) as cnt FROM v9_peixun_zhuanye_jilu");
$_row = $_result->fetch_assoc();
...
//1、由于英文字体Acens显示逗号时窄数字1与其他数字有差异，所以暂时改用KeepCal字体；
        ...
        //设置需要显示的数据
        var ArrayWrapData = [
            ['yewujingzhong', <?php echo $yewujingzhong?>],        // 业务警种
            ['yewujingzhong_count', <?php echo $yewujingzhong_count?>],            // 业务警种培训人次
            ['fujing', <?php echo $fujing?>],        // 辅警
    ...
    <div class="DigitalContent">
        ...
        <div id="modRenshi">
            ...
            <div class="modItemContent">
                ...
                <!--民警人数-->
                <div onclick="location.href='index.php?m=peixunnew&c=yewujingzhong&a=init'" style="cursor:pointer;" class="DataItem" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">业务警种培训数量</div>
                        <div class="DataItemNumber" id="yewujingzhong">0</div>
                    </div>
                </div>
                <!--辅警人数-->
                <div onclick="location.href='index.php?m=peixunnew&c=fujingpeixun&a=init'" style="cursor:pointer;" class="DataItem" data-scroll-reveal="enter right">
                    <div class="DataItemPic" data-scroll-reveal="wait .2s enter left">
                        <img src="statics/images/admin_img/2025/rs03.png">
                        <div class="DataItemLight"></div>
                    </div>
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">辅警培训数量</div>
                        <div class="DataItemNumber" id="fujing">0</div>
                    </div>
                </div>
                <!--实时考勤-->
                <div onclick="location.href='index.php?m=peixunnew&c=zhuanyepeixun&a=init'" style="cursor:pointer;"  class="DataItem" data-scroll-reveal="enter right">
                    <div class="DataItemPic" data-scroll-reveal="wait .2s enter left">
                        <img src="statics/images/admin_img/2025/rs03.png">
                        <div class="DataItemLight"></div>
                    </div>
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">专业培训数量</div>
        ...
        <div id="modHonour">
            <div class="modItemContent">
                ...
                <div  onclick="location.href='index.php?m=peixunnew&c=fujingpeixun_person&a=init'"  style="cursor:pointer;"   class="DataHonour" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">业务警种培训人次</div>
                        <div class="DataItemNumber" id="yewujingzhong_count">0</div>
                    </div>
                </div>
                ...
                <div onclick="location.href='index.php?m=peixunnew&c=fujingpeixun_jilu&a=init'" style="cursor:pointer;"   class="DataHonour" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">辅警培训人次</div>
                        <div class="DataItemNumber" id="fujing_count">0</div>
                    </div>
                </div>
