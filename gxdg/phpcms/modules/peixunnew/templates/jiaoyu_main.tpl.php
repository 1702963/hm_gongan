...
//1、由于英文字体Acens显示逗号时窄数字1与其他数字有差异，所以暂时改用KeepCal字体；
        ...
        //设置需要显示的数据
        var ArrayWrapData = [
            ['lilunpeixun', <?php echo $lilunpeixun?>],        // 业务警种
            ['jinengshixun', <?php echo $jinengshixun?>],            // 业务警种培训人次
            ['honglanduikang', <?php echo $honglanduikang?>],        // 辅警
            ['genrennengzhi', <?php echo $genrennengzhi?>]  // 辅警培训人次
        ];
            ...
            <div class="modItemContent">
                ...
                <div class="DataItem" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">理论培训</div>
                        <div class="DataItemNumber" id="lilunpeixun">0</div>
                    </div>
                </div>
                <!--辅警人数-->
                <div class="DataItem" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">技能实训</div>
                        <div class="DataItemNumber" id="jinengshixun">0</div>
                    </div>
                </div>
                <!--实时考勤-->
                <div class="DataItem" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">红蓝对抗</div>
                        <div class="DataItemNumber" id="honglanduikang">0</div>
                    </div>
                </div>                <!--实时考勤-->
                <div class="DataItem" data-scroll-reveal="enter right">
                    <div class="DataItemPic" data-scroll-reveal="wait .2s enter left">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">个人能值</div>
                        <div class="DataItemNumber" id="genrennengzhi">0</div>
                    </div>
                </div>
                <!--数据组结束-->
