...
<form action="?m=peixunnew&c=hebeiganyuan&a=addsave" method="POST" name="myform" id="myform">

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">河北干院培训计划</div>
  ...
  <tr>
    ...
    <td colspan="5">
      <select name="info[pxly]" id="pxly"
              style="width:300px;height:28px;background:#1a2a4a;color:#fff;border:1px solid #ddd;margin-left:5px;">
        <option value="河北干院" selected>河北干院</option>
      </select>
