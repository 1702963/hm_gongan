...
<form action="?m=peixunnew&c=tinen_xunlian_fankui&a=addsave" method="POST" name="myform" id="myform">

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">体能训练反馈</div>
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=peixunnew&c=tinen_xunlian_fankui&a=upload_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
$(function(){
    $("#fujing_search").bind("keyup click", function(){
        ...
        $.ajax({
            url: 'index.php?m=peixunnew&c=tinen_xunlian_fankui&a=searchfujing',
            type: 'POST',
