...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="number" name="info[shengao]" id="shengao" value="<?php echo $this->info['shengao']?>" step="0.1" min="100" max="250"
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="number" name="info[tizhong]" id="tizhong" value="<?php echo $this->info['tizhong']?>" step="0.1" min="30" max="200"
             style="width:200px;height:20px;background:transparent;color:#fff;border:1px solid #ddd;margin-left:5px;text-indent:1px"
             placeholder="请输入体重"/>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="number" name="info[tizhilv]" id="tizhilv" value="<?php echo $this->info['tizhilv']?>" step="0.1" min="0" max="100"
             style="width:200px;height:20px;background:transparent;color:#fff;border:1px solid #ddd;margin-left:5px;text-indent:1px"
             placeholder="请输入体脂率"/>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="number" name="info[yaowei]" id="yaowei" value="<?php echo $this->info['yaowei']?>" step="0.1" min="0" max="200"
             style="width:200px;height:20px;background:transparent;color:#fff;border:1px solid #ddd;margin-left:5px;text-indent:1px"
             placeholder="请输入腰围"/>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="number" name="info[tunwei]" id="tunwei" value="<?php echo $this->info['tunwei']?>" step="0.1" min="0" max="200"
             style="width:200px;height:20px;background:transparent;color:#fff;border:1px solid #ddd;margin-left:5px;text-indent:1px"
             placeholder="请输入臀围"/>
    </td>
  </tr>
