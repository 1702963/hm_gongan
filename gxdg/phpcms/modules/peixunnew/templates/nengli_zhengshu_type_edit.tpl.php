...
<form action="?m=peixunnew&c=nengli_zhengshu_type&a=editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo intval($info['id'])?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">编辑证书类型</div>
  ...
  <tr>
    ...
    <td colspan="5">
      <select name="info[leibie]" id="leibie"
        ...
        <option value="专业证书" <?php echo $info['leibie'] == '专业证书' ? 'selected' : ''?>>专业证书</option>
        <option value="荣誉证书" <?php echo $info['leibie'] == '荣誉证书' ? 'selected' : ''?>>荣誉证书</option>
      </select>
    </td>
  </tr>
