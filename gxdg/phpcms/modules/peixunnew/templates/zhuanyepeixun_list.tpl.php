...
<div class="explain-col">
  快速工具:
<a href="index.php?m=peixunnew&c=zhuanyepeixun&a=add"><input type="button" value="添加培训计划" style="margin-left:10px; width:100px" class="doLock" name="dook"></a>
</div>

<div class="search-box">
    <form method="GET" action="index.php">
        <input type="hidden" name="m" value="peixunnew">
        <input type="hidden" name="c" value="zhuanyepeixun">
        ...
        <label style="margin-left:15px;">培训来源：</label>
        <select name="pxly" style="width:120px;">
            <option value="">全部</option>
            <option value="警衔系统" <?php echo $this->pxly == '警衔系统' ? 'selected' : ''?>>警衔系统</option>
            <option value="河网干院" <?php echo $this->pxly == '河网干院' ? 'selected' : ''?>>河网干院</option>
        </select>
        ...
        <a href="index.php?m=peixunnew&c=zhuanyepeixun&a=init"><input type="button" value="重置" class="doLock"></a>
    </form>
</div>
...
if(is_array($this->list)){
    ...
    <tr>
      ...
      <td>
        &nbsp;<a href="index.php?m=peixunnew&c=zhuanyepeixun&a=edit&id=<?php echo $info['id']?>">编辑</a>
        &nbsp;<a href="index.php?m=peixunnew&c=zhuanyepeixun&a=del&id=<?php echo $info['id']?>" onclick="javascript:var r = confirm('确认删除该记录吗？');if(!r){return false;}">删除</a>
      </td>
    </tr>
   <?php
    $i++;}
