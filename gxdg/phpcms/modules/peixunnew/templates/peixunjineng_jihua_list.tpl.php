...
<div class="explain-col">
  快速工具:
<a href="index.php?m=peixunnew&c=peixunjineng_jihua&a=add"><input type="button" value="添加培训计划" style="margin-left:10px; width:100px" class="doLock" name="dook"></a>
</div>

<div class="search-box">
    <form method="GET" action="index.php">
        <input type="hidden" name="m" value="peixunnew">
        <input type="hidden" name="c" value="peixunjineng_jihua">
        ...
        <a href="index.php?m=peixunnew&c=peixunjineng_jihua&a=init"><input type="button" value="重置" class="doLock"></a>
    </form>
</div>
...
if(is_array($this->list)){
    ...
    <tr>
      ...
      <td>
        &nbsp;<a href="index.php?m=peixunnew&c=peixunjineng_jihua&a=edit&id=<?php echo $info['id']?>">编辑</a>
        &nbsp;<a href="index.php?m=peixunnew&c=peixunjineng_jihua&a=del&id=<?php echo $info['id']?>" onclick="javascript:var r = confirm('确认删除该记录吗？');if(!r){return false;}">删除</a>
      </td>
    </tr>
   <?php
    $i++;}
