...
<form action="?m=peixunnew&c=qiangzhi_sheji_fankui&a=editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo $this->info['id']?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">编辑射击反馈</div>
      ...
      <select name="info[jihua_id]" id="jihua_id" required
        ...
        if(is_array($this->jihua_list)){
            foreach($this->jihua_list as $jh){
                $selected = ($jh['id'] == $this->info['jihua_id']) ? 'selected' : '';
