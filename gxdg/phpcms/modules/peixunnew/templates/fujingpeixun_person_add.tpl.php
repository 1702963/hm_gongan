...
<form action="?m=peixunnew&c=fujingpeixun_person&a=addsave" method="POST" name="myform" id="myform">

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">业务警种培训记录</div>
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    <td align="right" class="infotitle">参训警种：</td>
    <td colspan="5">
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=peixunnew&c=fujingpeixun_person&a=upload_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
$(function(){
    $("#fujing_search").bind("keyup click", function(){
        ...
        $.ajax({
            url: 'index.php?m=peixunnew&c=fujingpeixun_person&a=searchfujing',
            type: 'POST',
