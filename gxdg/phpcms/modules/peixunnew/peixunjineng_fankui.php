...
class peixunjineng_fankui extends admin
{
    var $db;
    ...
    public function __construct()
    {
        ...
        $this->db->table_name = 'v9_peixun_jineng_fankui';
    ...
    public function init()
    {
        ...
        // 获取培训计划列表（用于显示培训标题）
        $this->db->table_name = 'v9_peixun_jineng_jihua';
        ...
        $this->list = $list;
        $this->pages = $pages;
        include $this->admin_tpl('peixunjineng_fankui_list');
    }
    ...
    public function add()
    {
        ...
        $this->select_bumen = $select_bumen;
        include $this->admin_tpl('peixunjineng_fankui_add');
    }
    ...
    public function addsave()
    {
        if (isset($_POST['dosubmit'])) {
            ...
            if ($result) {
                showmessage('添加成功', '?m=peixunnew&c=peixunjineng_fankui&a=init');
            } else {
    ...
    public function edit()
    {
        ...
        $this->select_bumen = $select_bumen;
        $this->info = $info;
        include $this->admin_tpl('peixunjineng_fankui_edit');
    }
    ...
    public function editsave()
    {
        if (isset($_POST['dosubmit'])) {
            ...
            if ($result !== false) {
                showmessage('修改成功', '?m=peixunnew&c=peixunjineng_fankui&a=init');
            } else {
    ...
    public function del()
    {
        ...
        if ($result) {
            showmessage('删除成功', '?m=peixunnew&c=peixunjineng_fankui&a=init');
        } else {
    ...
    public function upload_image()
    {
        ...
        $upload_path = 'uploadfile/peixun/jineng_zhengshu/' . date('Y/md') . '/';
