...
class zhuanxiang_yanlian extends admin
{
    var $db;
    ...
    public function init()
    {
        ...
        $this->list = $list;
        $this->pages = $pages;
        include $this->admin_tpl('zhuanxiang_yanlian_list');
    }
    ...
    public function add()
    {
        ...
        $this->select_bumen = $select_bumen;
        include $this->admin_tpl('zhuanxiang_yanlian_add');
    }
    ...
    public function addsave()
    {
        if (isset($_POST['dosubmit'])) {
            ...
            if (!$bmid || !$title) {
                showmessage('部门和标题不能为空', 'index.php?m=peixunnew&c=zhuanxiang_yanlian&a=init');
            }
            ...
            if ($result) {
                showmessage('添加成功', 'index.php?m=peixunnew&c=zhuanxiang_yanlian&a=init');
            } else {
                showmessage('添加失败', 'index.php?m=peixunnew&c=zhuanxiang_yanlian&a=init');
            }
        }
    }
    ...
    public function edit()
    {
        ...
        $this->select_bumen = $select_bumen;
        $this->info = $info;
        include $this->admin_tpl('zhuanxiang_yanlian_edit');
    }
    ...
    public function editsave()
    {
        if (isset($_POST['dosubmit'])) {
            ...
            if ($result) {
                showmessage('修改成功', 'index.php?m=peixunnew&c=zhuanxiang_yanlian&a=init');
            } else {
                showmessage('修改失败', 'index.php?m=peixunnew&c=zhuanxiang_yanlian&a=init');
            }
        }
    }
    ...
    public function del()
    {
        ...
        if ($result) {
            showmessage('删除成功', 'index.php?m=peixunnew&c=zhuanxiang_yanlian&a=init');
        } else {
            showmessage('删除失败', 'index.php?m=peixunnew&c=zhuanxiang_yanlian&a=init');
        }
    }
}
?>
