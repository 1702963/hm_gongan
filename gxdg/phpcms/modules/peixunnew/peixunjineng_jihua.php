...
class peixunjineng_jihua extends admin
{
    var $db;
    ...
    public function init()
    {
        ...
        $this->list = $list;
        $this->pages = $pages;
        include $this->admin_tpl('peixunjineng_jihua_list');
    }
    ...
    public function add()
    {
        ...
        $this->select_bumen = $select_bumen;
        include $this->admin_tpl('peixunjineng_jihua_add');
    }
    ...
    public function addsave()
    {
        if (isset($_POST['dosubmit'])) {
            ...
            if ($result) {
                showmessage('添加成功', '?m=peixunnew&c=peixunjineng_jihua&a=init');
            } else {
    ...
    public function edit()
    {
        ...
        $this->select_bumen = $select_bumen;
        $this->info = $info;
        include $this->admin_tpl('peixunjineng_jihua_edit');
    }
    ...
    public function editsave()
    {
        if (isset($_POST['dosubmit'])) {
            ...
            if ($result !== false) {
                showmessage('修改成功', '?m=peixunnew&c=peixunjineng_jihua&a=init');
            } else {
    ...
    public function del()
    {
        ...
        if ($result) {
            showmessage('删除成功', '?m=peixunnew&c=peixunjineng_jihua&a=init');
        } else {
