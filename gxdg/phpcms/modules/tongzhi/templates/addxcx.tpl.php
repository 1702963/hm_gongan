...
<div class="pad-lr-10">
<form action="?m=tongzhi&c=xcx&a=addxcx" method="POST" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		<th width="192">通知标题：</th>
		<td width="1013"><input type="input" name="info[title]"  style="width:400px;"/></td>
		<td width="442">标题图：</td>
	</tr>
	<tr>
		<th width="192"></th>
		<td width="1013" align="left">
        
        </td>
		<td width="442" rowspan="5" align="center" valign="top">
<div style="border: none;" class='upload-pic img-wrap'><input type='hidden' name='info[titpic]' id='thumb' value=''>
			...
			<img src='<?php echo IMG_PATH;?>icon/upload-pic.png' id='thumb_preview' width='200' height='150' style='cursor:hand' />
			</a>
...
<tr>
		<th width="192">通知内容：</th>
		<td width="1013">
		  <textarea name="info[content]" style="width:650px; height:400px;" id="content" boxid="content" ></textarea>
    ...
    <tr>
		<th width="192">阅读范围：</th>
		<td width="1013"><?php echo form::select($zhudi,'','name=info[zhudi] ')?></td>
	  </tr>
    
    <tr>
		<th width="192">阅读记录：</th>
		<td width="1013"><?php echo form::select(array(0=>'不记录',1=>'记录'),0,'name=info[doread] ')?></td>
	  </tr>
