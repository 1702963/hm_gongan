...
<table cellpadding="0" cellspacing="0" class="baseinfo">
 ...
 <tr>
    <td width="15%" align="right" class="infotitle" style="padding-left:20px;border-bottom:0px">原层级：</td>
    <td width="85%" align="left"  style="border-bottom:0px">
    <select name="info[newdw]" class="infoinput" style="height:30px">
                    
                      <option value=""><?php echo $cengjis[$info['oldcj']];?></option>
                   
        </select> &nbsp;
    </td>
  </tr>
  <tr>
    <td align="right" class="infotitle" style="padding-left:20px;border-bottom:0px">变更后层级：</td>
    <td align="left"  style="border-bottom:0px">
    <select name="info[newdw]" class="infoinput" style="height:30px">
                    
                      <option value=""><?php echo $cengjis[$info['newcj']];?></option>
