...
<div class="cat_total">
	<div class="cat_total_con ra"><div class="tcon"><span>发起申请</span></div></div>
    <div class="cat_total_con ra"><div class="tcon"><span><a href="index.php?m=shenpi&c=renyuanshenpi&a=init" style="color:#ffffff">返回上级</a></span></div></div>
</div>
<div class="sys_info">
	<div class="sys_info_title">岗位变动审批记录</div>
