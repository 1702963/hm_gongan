...
<div class="cat_total">
	<div class="cat_total_con ra"><div class="tcon"><span><a href="index.php?m=shenpi&c=cengjishenpi&a=biandonglist" style="color:#ffffff">工资表审核</a></span></div></div>
    <div class="cat_total_con ra"><div class="tcon"><span><a href="index.php?m=shenpi&c=cengjishenpi&a=qingkuanglist" style="color:#ffffff">考勤审核</a></span></div></div>
    <div class="cat_total_con ra"><div class="tcon"><span><a href="index.php?m=shenpi&c=cengjishenpi&a=qingkuanglist" style="color:#ffffff">特殊任务申请</a></span></div></div>
</div>
<div class="sys_info">
