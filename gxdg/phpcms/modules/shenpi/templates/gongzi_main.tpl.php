...
?>
<div class="cat_total">
	<div class="cat_total_con ra"><div class="tcon"><span><a href="javascript:;" onClick="gangwei()" style="color:#ffffff">工资审核申请</a></span></div></div>
...
if(is_array($msgs)){
	...
	<tr onDblClick="show(<?=$info['id']?>);">
        ...
        <?php if($info['dodt']==0){?>
           <a href="index.php?m=shenpi&c=gongzishenpi&a=<?php echo $info['doty']?>&yues=<?php echo $info['yues']?>&msgid=<?php echo $info['id']?>&doty=<?php echo $info['doty']?>&bmid=<?php echo $info['addbm']?>" style="color:#F00">待审批</a>
        <?php }else{?>
           <a href="index.php?m=shenpi&c=gongzishenpi&a=<?php echo $info['doty']?>&yues=<?php echo $info['yues']?>&msgid=<?php echo $info['id']?>&doty=<?php echo $info['doty']?>&bmid=<?php echo $info['addbm']?>" style="color:#0F0">已审批</a>        
        <?php }?>
        </td>
	</tr>
	<?php
