...
<div class="table-list" style="scroll-x:auto">
	...
	&nbsp; <input type="button" name="but1" value="审核突出贡献" style="border-radius:.4em;cursor:pointer; width:100px; height:25px; background-color:#06C; color:#FFF;display:" onclick="bmshenhe_do('<?php echo $nowyue[0]['yue']?>','juuser2','<?php echo $show_table[0]['bmid']?>','<?php echo $_GET['msgid']?>')" <?php echo $buttoncan?>/>
	</div>
