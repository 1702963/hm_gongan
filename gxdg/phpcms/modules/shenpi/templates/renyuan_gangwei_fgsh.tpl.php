...
<form action="?m=shenpi&c=renyuanshenpi&a=fgsh" method="POST" name="myform" id="myform" >
...
<table cellpadding="0" cellspacing="0" class="baseinfo">
  ...
  <tr>
    ...
    <td width="59%" align="left"  style="border-bottom:0px"><?php echo form::select(array(9=>'同意',2=>'不同意'),9,'name=fgstatus   ')?></td>
  </tr>
   <tr>
    <td align="right" class="infotitle" style="padding-left:20px;border-bottom:0px">转交政治处主任：</td>
    <td align="left" class="infotitle" style="border-bottom:0px"><?php echo form::select($ld,'','name=zrshid   ')?></td>
  </tr>
</table>
</div>
