...
?>
<div class="cat_total">
	<div class="cat_total_con ra"><div class="tcon"><span><a href="javascript:;" onClick="gangwei()" style="color:#ffffff">岗位变动申请</a></span></div></div>
...
if(is_array($infos)){
  ...
  <tr>
    <td width="12%" align="left"><strong>调动前</strong></td>
  ...
  <tr>
    <td align="left"><strong>调动后</strong></td>
    <td align="center"><?=$bumens[$info['newdw']]?></td>
    <td align="center"><?=$gangweis[$info['newgangwei']]?></td>
    <td align="center"><?=$fzgangweis[$info['newgangweifz']]?></td>
  </tr>
</table>
		...
		<a href="?m=shenpi&c=renyuanshenpi&a=word&id=<?php echo $info['id']?>" >导出word</a>
		</td>
	</tr>
	<?php
	}
