...
<?php }?>
    ...
    <div style=" width:100%;font-size:16px; text-align:center; margin-bottom:5px"><b>唐山高新区管委会短期合同制工作人员考勤表(<?php echo $dbnames?>)</b>&nbsp; <input type="button" name="but1" value="审核考勤" style="border-radius:.4em;cursor:pointer; width:100px; height:25px; background-color:#06C; color:#FFF;display:" onclick="bmshenhe_do('<?php echo $dbnames?>','<?php echo $_GET['doty']?>','<?php echo $show_table[0]['bmid']?>','<?php echo $_GET['msgid']?>')" <?php echo $buttoncan?>/> </div>
