...
<table cellpadding="0" cellspacing="0" class="baseinfo">
 ...
 <tr>
    <td align="right" class="infotitle" style="padding-left:20px;border-bottom:0px">原部门/岗位/岗位辅助：</td>
    ...
    辅助岗位     <select name="info[newgangweifz]" class="infoinput" style="height:30px">
  ...
  <tr>
    <td align="right" class="infotitle" style="padding-left:20px;border-bottom:0px">申请调动至：</td>
    <td align="left"  style="border-bottom:0px">
    <select name="info[newdw]" class="infoinput" style="height:30px">
                    
                      <option value=""><?php echo $bumens[$info['newdw']];?></option>
                   
                    </select> &nbsp;
    <select name="info[newgangwei]" class="infoinput" style="height:30px">
                    
                      <option value=""><?php echo $gangweis[$info['newgangwei']];?></option>
                     
          </select> &nbsp;
    辅助岗位     <select name="info[newgangweifz]" class="infoinput" style="height:30px">
                     
                      <option value="<?php echo $k?>"><?php echo $fzgangweis[$info['newgangweifz']];?></option>
  ...
  <tr>
   ...
   <tr>
	...
	<?php if($info['bmshid']){?><?php echo $ld[$info['bmshid']]?>:<span class="c<?php echo $info['bmstatus'];?>"><?php echo $zt[$info['bmstatus']];?></span><?php }?> &nbsp;&nbsp;&nbsp;&nbsp;<?php if($info['bmshtime']){echo date("Y-m-d",$info['bmshtime']);}?><br>
		...
		<?php if($info['ldshid']){?><?php echo $ld[$info['ldshid']]?>:<span class="c<?php echo $info['ldstatus'];?>"><?php echo $zt[$info['ldstatus']];?></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php if($info['ldshtime']){echo date("Y-m-d",$info['ldshtime']);}?>  <?php if($info['dai']==1){?><span class="c2">代签</span> <?php }?> <?php }?>
