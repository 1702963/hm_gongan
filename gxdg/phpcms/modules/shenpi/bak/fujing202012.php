...
$tableheader2 = array('序号','工作单位','姓名','性别','身份证号','年龄','出生日期','学历','入警时间','政治面貌','退役','岗位类别','辅助岗位','职务','层级','电话'); 
...
$qz=$hang+1;
	...
	$obpe->getActiveSheet()->getStyle( "A1:P$qz")->applyFromArray($styleThinBlackBorderOutline);	 
