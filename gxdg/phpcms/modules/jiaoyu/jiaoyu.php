...
class jiaoyu extends admin
{
    ...
    public function lilunpeixun()
    {
        header("Location:?m=peixunnew&c=peixunnew&a=init");
        exit;
        showmessage('模块建设中');
    }
    ...
    {
        header("Location:?m=peixunnew&c=jiaoyu&a=init");
        exit;
        showmessage('模块建设中');
        /////////////////////////////////////
...
//输出表格
        ...
        for ($i = 0; $i < $hang; $i++) { //行
            ...
            if ($daoxls[$i]['shengao'] > 0) {
                $v24 = $daoxls[$i]['shengao'];
            } else {
                $v24 = "";
            }
            if ($daoxls[$i]['tizhong'] > 0) {
                $v25 = $daoxls[$i]['tizhong'];
            } else {
                $v25 = "";
            }
            if ($daoxls[$i]['bmi'] > 0) {
            ...
            $v27 = $daoxls[$i]['minzu'];
            if (intval($daoxls[$i]['lizhitime']) > 0) {
                $v28 = date("Y-m-d", $daoxls[$i]['lizhitime']);
            } else {
                $v28 = "";
            }

            if (intval($daoxls[$i]['rdtime']) > 0) {
                $v29 = date("Y-m-d", $daoxls[$i]['rdtime']);
            } else {
                $v29 = "";
            }
            if (intval($daoxls[$i]['rdzztime']) > 0) {
                $v30 = date("Y-m-d", $daoxls[$i]['rdzztime']);
            } else {
                $v30 = "";
            }
            $v31 = $daoxls[$i]['gzz'];
