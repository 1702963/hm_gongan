...
class gongwu extends admin {
	...
	public function init() {
		//showmessage('执法办案数据对接中');
		/////////////////////////////////////
		///这里更新年龄，每次都触发，原则上应使用计划任务每天凌晨进行一次触发，暂时放在这里
						
			
		include $this->admin_tpl('gongwu_list');
	}
	...
	function addche()
	{
		...
		include $this->admin_tpl('addche_gongwu');
	}

	function showche()
	{
		
		include $this->admin_tpl('edit_gongwu');
	}
