...
$_POST['in']['yq_dwid']=$bmfy[$_POST['in']['yq_danwei']];
...
<form action="?m=jiandu&c=yuqing&a=addyq" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    ...
    <td width="187"><?php echo form::date('in[cjdt]',date("Y-m-d"),0,0,'false')?></td>    
    <td width="152" align="right" class="infotitle">舆情发生日期：</td>
    <td width="172" class="rb"><?php echo form::date('in[wgdt]',date("Y-m-d"),0,0,'false')?></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2"><span class="rb">
        <select name="in[yq_danwei]" class="infoselect">
                      ...
                      <option value="<?php echo $v?>" <?php if($jd['yc_danwei']==$v){?>selected<?php }?>><?php echo $v?></option>
                      <?php }?>
                    </select>
    </span></td>
    </tr>
...
['Source','-','Templates'],
  ...
  <tr>
    ...
    <td colspan="2"><?php echo form::date('in[cldt]',date("Y-m-d"),0,0,'false')?> &nbsp;<input type="checkbox" name="in[cled]" value="1" <?php if($jd['cled']==1){?>checked="checked"<?php }?>/> &nbsp;已处理</td>
  </tr>
  <tr>
...
['Source','-','Templates'],
  ...
  <tr>
    ...
    <td colspan="2" id="uplist-qtups">&nbsp;</td>
  </tr>
</table>
