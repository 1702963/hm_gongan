...
$_POST['in']['yc_dwid']=$bmfy[$_POST['in']['yc_danwei']];
...
<form action="?m=jiandu&c=gongwu&a=addche" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    ...
    <td width="246"><input type="text" id="xingming" name="in[yc_xingming]" value="<?php echo $jd['yc_xingming'];?>" class="infoinput" />
       ...
       </div><input type="hidden" name="in[yc_uid]" id="uid" />     
    </td>
...
['Source','-','Templates'],
  ...
  <tr>
    ...
    <td colspan="2"><?php echo form::date('in[cldt]',date("Y-m-d"),0,0,'false')?> &nbsp; <input type="checkbox" name="in[cled]" value="1" /> &nbsp;已处理</td>
  </tr>
  <tr>
