...
<input type="hidden" value="wang" name="c">
<input type="hidden" value="init" name="a">
<input type="hidden" value="<?php echo $status;?>" name="status">
<div class="explain-col"> 
  快速工具:   现场监督/网上监督 &nbsp;                      
<a href="?m=jiandu&c=wang&a=addwang"><input type="button" value="新增" class="button" name="dook"></a>  
		</div>
</form>
...
<table width="100%" border="0">
  <tr>
    <td height="30">
  违纪人: <input type="text" value="<?php echo $xingming?>" class="input-text" size="6" name="xingming">&nbsp;&nbsp;
  违纪人所在单位：<select name="dwid">
...
<table width="100%" cellspacing="0" class="kotable">
	...
	<tr>
      ...
      <th width="149">违纪人</th>
	  <th width='127'>所属单位</th>
	  <th width="140">违纪采集时间</th>
      <th width="154">违纪描述</th>
	  <th width="185">违纪类型</th>
      <th width="206">处理意见</th>  
      <th width="182">处理时间</th>
      <th width="261">处理结果</th>
      <th width="210">处理状态</th>
      <th width="159">操作</th>
	</tr>
    </thead>
    <tbody>
...
if(is_array($jdlist)){
	...
	<tr>
	  ...
	  <td><?php echo mb_substr($info['wgleixing'], 0, 10, "UTF-8")?></td>
	  ...
	  ?></td>
      <td>
       <a href="index.php?m=jiandu&c=wang&a=showwang&id=<?php echo $info['id']?>&status=<?php echo $status;?>">查看</a>
        
        &nbsp;<a href="index.php?m=jiandu&c=wang&a=editwang&id=<?php echo $info['id']?>&status=<?php echo $status;?>">修改</a>
        
        &nbsp;<a href="index.php?m=jiandu&c=wang&a=zuofei&dofei=1&ids=<?php echo $info['id']?>&status=<?php echo $status;?>" onclick="javascript:var r = confirm('确认作废当前记录吗？');if(!r){return false;}">作废</a>               
      </td>
	</tr>
   <?php
	$i++;}
