...
<form action="?m=jiandu&c=zhifa&a=editzf" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    ...
    <td width="172" class="rb"><?php echo form::date('in[jadt]',date("Y-m-d",$jd['jadt']),0,0,'false')?></td>
    </tr>
...
['Source','-','Templates'],
  ...
  <tr>
    ...
    <td><?php echo form::date('in[lrdt]',date("Y-m-d",$jd['lrdt']),0,0,'false')?></td>
    </tr>
  <tr>
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    ...
    <td width="246"><input type="text" id="xingming" name="in[xingming]" value="<?php echo $jd['xingming'];?>" class="infoinput" />
       ...
       </div><input type="hidden" name="in[uid]" id="uid" value="<?php echo $jd['uid']?>"/>     
    </td>
...
<table cellpadding="0" cellspacing="0" class="baseinfo">
  ...
  <tr>
    ...
    <td width="282"><?php if($jd['cled']=="1"){$cldt=$jd['cldt'];}else{$cldt=time();} echo form::date('in[cldt]',date("Y-m-d",$cldt),0,0,'false')?> &nbsp; <input type="checkbox" name="in[cled]" value="1" <?php if($jd['cled']=="1"){?>checked="checked"<?php }?>/> &nbsp;已处理</td>
  ...
  <tr>
    <td width="142" align="right" class="infotitle">处分时间：</td>
    <td><?php if($jd['cfed']=="1"){$cfdt=$jd['cfdt'];}else{$cfdt=time();} echo form::date('in[cfdt]',date("Y-m-d",$cfdt),0,0,'false')?> &nbsp; <input type="checkbox" name="in[cfed]" value="1" <?php if($jd['cfed']=="1"){?>checked="checked"<?php }?>/> &nbsp;已处分</td>
  ...
  <tr>
    ...
    <td><?php if($jd['djed']=="1"){$djdt=$jd['djcfdt'];}else{$djdt=time();} echo form::date('in[djcfdt]',date("Y-m-d",$djdt),0,0,'false')?> &nbsp; <input type="checkbox" name="in[djed]" value="1" <?php if($jd['djed']=="1"){?>checked="checked"<?php }?>/> &nbsp;已处分</td>
    <td align="right" class="infotitle">政务处分时间</td>
    <td colspan="3"><?php if($jd['zwed']=="1"){$zwdt=$jd['zwcfdt'];}else{$zwdt=time();} echo form::date('in[zwcfdt]',date("Y-m-d",$zwdt),0,0,'false')?> &nbsp; <input type="checkbox" name="in[zwed]" value="1" <?php if($jd['zwed']=="1"){?>checked="checked"<?php }?>/> &nbsp;已处分</td>
  </tr>
  <tr>
