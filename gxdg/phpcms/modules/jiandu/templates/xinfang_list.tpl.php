...
<input type="hidden" value="xinfang" name="c">
<input type="hidden" value="init" name="a">
<input type="hidden" value="<?php echo $status;?>" name="status">
<div class="explain-col"> 
  快速工具:   信访 &nbsp;                      
<a href="?m=jiandu&c=xinfang&a=addxf"><input type="button" value="新增" class="button" name="dook"></a>  
		</div>
</form>
...
<table width="100%" border="0">
  <tr>
    <td height="30">
  信访人: <input type="text" value="<?php echo $xingming?>" class="input-text" size="6" name="xingming">&nbsp;&nbsp;
  信访所涉单位：<select name="dwid">
...
<table width="100%" cellspacing="0" class="kotable">
	<thead>
	<tr>
      <th width='82' height="32">序号</th>
      <th width="159">信访人</th>
	  <th width='135'>信访来源</th>
	  <th width="183">接访时间</th>
      <th width="165">信访人联系方式</th>
	  <th width="267">信访内容</th>
      <th width="171">接访人</th>  
      <th width="190">涉及单位</th>
      <th width="229">处理状态</th>
      <th width="271">操作</th>
	</tr>
    </thead>
    <tbody>
...
if(is_array($jdlist)){
	...
	<tr>
      ...
      <td><?php echo $i?></td>
      <td><?php echo $info['xf_xingming']?></td>
      <td><?php echo $info['xfyuan']?></td>
	  <td><?php echo date("Y-m-d",$info['xfdt'])?></td>
      <td><?php echo $info['xflxfs']?></td>
	  <td><?php echo mb_substr($info['wgnr'], 0, 10, "UTF-8")?></td>
      <td><?php echo $info['xingming']?></td>
      <td><?php echo $info['jf_danwei']?></td>
      <td><?php 
	          $clzt="违规信息采集";
	          if($info['clyj']!=""){
				 $clzt="已出具意见"; 
	  ...
	  ?></td>
      <td>
         <a href="index.php?m=jiandu&c=xinfang&a=showxf&id=<?php echo $info['id']?>&status=<?php echo $status;?>">查看</a>
        
        &nbsp;<a href="index.php?m=jiandu&c=xinfang&a=editxf&id=<?php echo $info['id']?>&status=<?php echo $status;?>">修改</a>
        
        &nbsp;<a href="index.php?m=jiandu&c=xinfang&a=zuofei&dofei=1&ids=<?php echo $info['id']?>&status=<?php echo $status;?>" onclick="javascript:var r = confirm('确认作废当前记录吗？');if(!r){return false;}">作废</a>              
      </td>
	</tr>
   <?php
	$i++;}
