...
$_POST['in']['jf_dwid']=$bmfy[$_POST['in']['jf_danwei']];
...
<form action="?m=jiandu&c=xinfang&a=addxf" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    ...
    <td width="187"><?php echo form::date('in[xfdt]',date("Y-m-d"),0,0,'false')?></td>    
  ...
  <tr>
    ...
    <td colspan="2">
      <input type="text" name="in[xingming]" id="xingming" class="infoinput"  value="<?php echo $jd['xingming'];?>" />
       ...
       <input type="hidden" name="in[uid]" id="uid" value="<?php echo $bz['uid'];?>" />     
    </td>
    </tr>
  <tr>
