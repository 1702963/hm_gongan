...
<table cellpadding="2" cellspacing="1" class="table_form">
	...
	<tr>
		<td width="10%" height="37"><strong>家属姓名：</strong></td>
		<td width="20%"><input type="input" name="info[xingming]"  style="width:200px;"  required  oninvalid="setCustomValidity('请填写家属姓名');" oninput="setCustomValidity('');" /></td>
		<td width="10%"><strong>性别：</strong></td>
		<td width="20%"><?php echo form::select(array('男'=>'男','女'=>'女'),'男','name=info[sex]  class=infoselect')?></td>
		<td width="10%" height="37"><strong>身份证：</strong></td>
		<td width="30%"><input type="input" name="info[sfz]"  style="width:250px;"  required  oninvalid="setCustomValidity('请填写身份证号码');" oninput="setCustomValidity('');" /></td>
	</tr>
    
    
    
	<tr>
		<td width="" height="37"><strong>电话：</strong></td>
		<td width=""><input type="input" name="info[tel]"  style="width:200px;"  required  oninvalid="setCustomValidity('请填写电话号码');" oninput="setCustomValidity('');"/></td>
		<td width=""><strong>住址：</strong></td>
		<td width="" colspan="3"><input type="input" name="info[dizhi]"  style="width:600px;"  required  oninvalid="setCustomValidity('请填写住址');" oninput="setCustomValidity('');"/></td>
	</tr>
	<tr>
		<td width=""><strong>与辅警关系：</strong></td>
		<td width=""><?php echo form::select(array('父亲'=>'父亲','母亲'=>'母亲','配偶'=>'配偶','伯父'=>'伯父','伯母'=>'伯母','叔叔'=>'叔叔','婶母'=>'婶母','祖父母'=>'祖父母','外祖父母'=>'外祖父母','儿子'=>'儿子','女儿'=>'女儿','哥哥'=>'哥哥','姐姐'=>'姐姐','弟弟'=>'弟弟','妹妹'=>'妹妹','岳母'=>'岳母','岳父'=>'岳父','妻兄'=>'妻兄','妻姐'=>'妻姐','妻弟'=>'妻弟','妻妹'=>'妻妹'),'','name=info[guanxi] class=infoselect')?></td>
		<td width="" height="37"><strong>工作单位：</strong></td>
		<td width="" colspan="3"><input type="input" name="info[gzdw]"  style="width:600px;"  required  oninvalid="setCustomValidity('请填写工作单位');" oninput="setCustomValidity('');" /></td>
