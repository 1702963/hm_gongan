...
<div class="tableContent">
	<form name="myform" action="?m=admin&c=dzbumen&a=listorder" method="post">
	<div class="pad-lr-10">
		<div class="explain-col" style="margin-bottom:5px">
			<input type="button" value="添加一级党组织" class="button" name="dotongji" >
		</div>
...
<!--
	$(function(){
		...
		$("#name").formValidator({onshow:"请输入党组织名称",onfocus:"请输入党组织名称",oncorrect:"正确"}).inputValidator({min:1,onerror:"请输入党组织名称"});
...
<div class="tableContent">
    <div class="common-form">
        <form name="myform" id="myform" action="?m=admin&c=dzbumen&a=add" method="post">
        <table width="100%" class="kotable table_form">
              <tr>
                <th colspan="2"><h3>添加子组织</h3></th>
              </tr>
              <tr>
                <th width="200" align="right"><b>上级组织：</b></th>
        ...
        <?php echo $select_categorys;?>
              ...
              <tr>
                <th align="right"><b>党组织名称：</b></th>
                <td><span><input type="text" name="info[name]" id="name" class="input-text" style="width:350px"></span></td>
              </tr>
              
              <tr>
                <th align="right"><b>党组织名称简称：</b></th>
                <td><span><input type="text" name="info[sname]" id="sname" class="input-text" style="width:350px"></span></td>
              </tr>              
        </table>
        <!--table_form_off-->
...
<div class="tableContent">
<div class="common-form">
<form name="myform" id="myform" action="?m=admin&c=dzbumen&a=edit" method="post">
<table width="100%" class="kotable table_form">
	  <tr>
...
<?php echo $select_categorys;?>
      ...
      <tr>
        <th align="right"><b>党组织名称：</b></th>
        <td><input type="text" name="info[name]" id="name" class="input-text" value="<?php echo $name?>" style="width:350px"></td>
      </tr>
	
      <tr>
        <th align="right"><b>党组织名称简称：</b></th>
        <td><input type="text" name="info[sname]" id="sname" class="input-text" value="<?php echo $sname?>" style="width:350px"></td>
      </tr>
