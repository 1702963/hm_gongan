...
<style>
.col-tab .contentList {border:0;background:rgba(0,0,0,0.3);border-radius:5px;backdrop-filter:blur(10px)}
.table_form td , .table_form th {padding:24px 0 24px 8px; color:#f0f0f0}
.table_form tbody td {border-bottom:0 solid #0e0957}
input.button, input.btn {width:120px;height:28px;font-size:12px}
.button {background:#09c;font-size:14px;border-radius:3px;margin-left:1%;margin-bottom:10px}
.button:hover {background:#3faa0f}
.doWhat {width:120px;height:28px;border:0;background:#3faa0f;border-radius:5px;marign-left:15px;color:#fff;cursor:pointer}
.doWhat:hover {background:#09c}
.col-tab ul {margin-top:40px;font-family:microsoft yahei;font-size:14px}
...
<ul class="tabBut cu-li">
            <li id="tab_setting_1" class="on" onclick="SwapTab('setting','on','',5,1);"><a href="javascript:void(0)"><?php echo L('setting_basic_cfg')?></a></li>
            <li id="tab_setting_2" onclick="SwapTab('setting','on','',5,2);"><a href="javascript:void(0)"><?php echo L('setting_safe_cfg')?></a></li>
            <li id="tab_setting_3" onclick="SwapTab('setting','on','',5,3);"><a href="javascript:void(0)"><?php echo L('setting_sso_cfg')?></a></li>
            <li id="tab_setting_4" onclick="SwapTab('setting','on','',5,4);"><a href="javascript:void(0)"><?php echo L('setting_mail_cfg')?></a></li>
			<li id="tab_setting_5" onclick="SwapTab('setting','on','',5,5);" style="display:none"><a href="javascript:void(0)"><?php echo L('setting_connect')?></a></li>
</ul>
<div id="div_setting_1" class="contentList pad-10">
<table width="100%"  class="table_form">
  <tr>
    <th width="200"><?php echo L('setting_admin_email')?></th>
  ...
  <tr>
    <th width="200"><?php echo L('setting_category_ajax')?></th>
  ...
  <tr>
    <th width="200"><?php echo L('setting_gzip')?></th>
    <td class="y-bg">
...
<div id="div_setting_2" class="contentList pad-10 hidden">
	<table width="100%"  class="table_form">
  <tr>
    <th width="200"><?php echo L('setting_admin_log')?></th>
    <td class="y-bg">
  ...
  <tr>
    <th width="200"><?php echo L('setting_error_log')?></th>
    <td class="y-bg">
...
<table width="100%"  class="table_form">
  <tr>
    <th width="200"><?php echo L('setting_phpsso')?></th>
    <td class="y-bg">
...
<table width="100%"  class="table_form">
  <tr>
    <th width="200"><?php echo L('mail_type')?></th>
    <td class="y-bg">
...
<table width="100%"  class="table_form">
  ...
  <tr>
    <th width="200"><?php echo L('setting_snda_enable')?></th>
    <td class="y-bg">
...
<div class="bk15"></div>
<input name="dosubmit" type="submit" value="<?php echo L('submit')?>" class="doWhat">
</div>
</div>
</form>
</body>
