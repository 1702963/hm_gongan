...
?>
<link href="<?php echo CSS_PATH?>dialog.css?ver=<?php echo time() ?>" rel="stylesheet" type="text/css" />
<script language="javascript" type="text/javascript" src="<?php echo JS_PATH?>dialog.js"></script>

<?php } ?>
	<link rel="stylesheet" type="text/css" href="<?php echo CSS_PATH?>style/<?php echo SYS_STYLE;?>-styles1.css?ver=<?php echo time() ?>" title="styles1" media="screen" />
