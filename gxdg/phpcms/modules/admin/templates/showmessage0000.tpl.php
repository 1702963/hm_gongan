...
html {height:100%}
body {background:url(statics/images/newMessagebgs.jpg) center center no-repeat}
a:link,a:visited{text-decoration:none;color:#0068a6}
a:hover,a:active{color:#ff6600;text-decoration: underline}
.showMsg{border: 1px solid #1e64c8; zoom:1; width:450px; height:172px;background:#fff;position:absolute;top:44%;left:50%;margin:-87px 0 0 -225px}
.showMsg h5{background:#00c1de; color:#fff; padding-left:12px; height:25px; line-height:26px;*line-height:28px; overflow:hidden; font-size:14px; text-align:left}
