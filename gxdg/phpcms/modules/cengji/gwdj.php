...
class gwdj extends admin {
	...
	public function init() {
		...
		$pages = $this->db->pages;
		include $this->admin_tpl('gwdj_list');
	}
	...
	function add()
	{
		...
		$this->db->insert($_POST['info']);
			...
			showmessage('操作完毕','index.php?m=cengji&c=gwdj');
		}
		
		include $this->admin_tpl('add_gwdj');
	}
	...
	function edit()
	{
		...
		include $this->admin_tpl('edit_gwdj');
	}
	function show()
	{
		$id=$_REQUEST['id'];
