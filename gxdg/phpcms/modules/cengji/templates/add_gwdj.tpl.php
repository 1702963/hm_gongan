...
<div class="pad-lr-10">
<form action="?m=cengji&c=gwdj&a=add" method="POST" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	<tr>
		<th width="142" height="36">岗位等级名称：</th>
		<td width="828"><input type="input" name="info[cjname]"  class="input-text"/></td>
		<td width="886">&nbsp;</td>
	</tr>
	<tr>
		<th width="142" height="36">工作年限：</th>
		<td width="828"><input type="input" name="info[nx1]"   class="input-text" style="width:210px;"/>&nbsp;至&nbsp;<input type="input" name="info[nx2]"   class="input-text" style="width:210px;"/></td>
		<td width="886">&nbsp;</td>
	</tr>
	<tr>
		<th width="142" height="37">等级工资：</th>
		<td width="828"><input type="input" name="info[gongzi]"  class="input-text"/></td>
		<td width="886">&nbsp;</td>
	</tr>
	<tr>
