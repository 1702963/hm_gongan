...
class xueli extends admin {
	...
	public function init() {
		...
		$pages = $this->db->pages;
		include $this->admin_tpl('xueli_list');
	}
	...
	function add()
	{
		...
		$this->db->insert($_POST['info']);
			...
			showmessage('操作完毕','index.php?m=gangwei&c=xueli');
		}
		
		include $this->admin_tpl('add_xueli');
	}
	...
	function edit()
	{
		...
		include $this->admin_tpl('edit_xueli');
	}
	function show()
	{
		$id=$_REQUEST['id'];
		...
		include $this->admin_tpl('show_xueli');
	}
	//更新排序
