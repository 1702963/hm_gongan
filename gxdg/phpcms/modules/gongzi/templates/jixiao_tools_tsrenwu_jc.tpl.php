...
<div class="table-list" style="scroll-x:auto">
    ...
    <div style=" width:100%;font-size:16px; text-align:center; margin-bottom:5px"><b>已关联到绩效工资表的特殊任务</b></div>
...
<table width="100%" cellspacing="0" border="1" style="margin-right:10px">
	<thead>
		<tr>
            ...
            <th align="center" style="font-size:12px;">解除关联</th>
		</tr>
	</thead>
<tbody>
...
<input type="hidden" name="a" value="toolsrenwujc" />
