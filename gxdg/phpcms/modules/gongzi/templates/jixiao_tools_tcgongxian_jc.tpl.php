...
<div class="table-list" style="scroll-x:auto">
    ...
    <div style=" width:100%;font-size:16px; text-align:center; margin-bottom:5px"><b>已关联到绩效工资表的突出贡献申请</b></div>
...
<input type="hidden" name="a" value="toolsgongxianjc" />
...
<?php if(is_array($infos)){
	...
	?>
		<tr>
            ...
            <td align="center" ><input name="sgdt" type="text" value="<?php echo $info['yue']?>" disabled="disabled" size="10"/></td>
            <td align="center" ><input name="bzje" type="text" value="<?php echo $info['je']?>" disabled="disabled" size="10"/>元</td>
            ...
            <td align="center" ><input type="checkbox" name="ids[]" value="<?php echo $info['id']?>" /></td>
		</tr>	                                                  
  <?php }}?>   
