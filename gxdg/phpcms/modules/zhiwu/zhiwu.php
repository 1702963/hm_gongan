...
class zhiwu extends admin {
	...
	public function init() {
		...
		$zhiwu = $this->db->listinfo('',$order = 'id asc',$page, $pages = '12');
		$pages = $this->db->pages;
	...
	function add()
	{
		...
		$this->db->insert($_POST['info']);
			...
			showmessage('操作完毕','index.php?m=zhiwu&c=zhiwu');
		}
	...
	function edit()
	{
		...
		$zhiwu = $this->db->get_one("id=$id",'*');
		
		include $this->admin_tpl('edit_zhiwu');
	}
	function show()
	{
		$id=$_REQUEST['id'];
