...
showmessage('操作完成','index.php?m=xuanchuan&c=sucai&a=lists');	
}
...
<form action="?m=xuanchuan&c=sucai&a=editsc" method="POST" name="myform" id="myform">
...
<div class="tabcon">
<div class="title" style="width:150px">素材基本情况</div>
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    <td align="right" class="infotitle">素材标题：</td>
  ...
  <tr>
    ...
    <td width="246"><input type="text" id="zuozhe" name="in[zuozhe]" value="<?php echo $xc['zuozhe'];?>" class="infoinput" />
       ...
       </div><input type="hidden" name="in[zzuid]" id="zzuid" value="<?php echo $xc['zzuid']?>" />     
    </td>
...
<input type="text" id="sbren" name="in[sbren]" value="<?php echo $xc['sbren'];?>" class="infoinput" />
       ...
       </div><input type="hidden" name="in[sbuid]" id="sbuid" value="<?php echo $xc['sbuid']?>" />     
    </td>
    </tr>
  <tr>
    <td align="right" class="infotitle">素材类型：</td>
    <td width="246">
          <select name="in[gjleixing]" class="infoselect">
    ...
    <td width="100" align="right" class="infotitle">说明：</td>
    <td colspan="3">上报素材应在“素材内容”内粘贴素材文字内容，同时素材电子档文件及相关材料已附件方式上传</td>
  </tr>
  <tr>
    <td align="right" class="infotitle">素材内容：</td>
    <td colspan="5">
...
['Source','-','Templates'],
  ...
  <tr>
    <td align="right" class="infotitle">素材资料：</td>
...
<table cellpadding="0" cellspacing="0" class="baseinfo">
  <tr>
    ...
    <td><input type="text" name="in[shbz]" id="shbz" class="infoinput"  value="<?php echo $xc['shbz'];?>" style="width:300px"/> &nbsp;  <?php if($_GET['a']=="editsc"){?><input type="submit" class="dow" name="doshenhe" value="审核" /><?php }?></td>
    </tr>
  <tr>
...
['Source','-','Templates'],
  ...
  <tr>
    <td align="right" class="infotitle">采用状态：</td>
    ...
    <td align="right" class="infotitle">采用时间：</td>
    <td><?php echo form::date('in[cydt]',date("Y-m-d",$xc['cydt']),0,0,'false')?></td>
  </tr>
  <tr>
    <td align="right" class="infotitle">发表媒体：</td>
    <td><input type="text" name="in[meiti]" id="meiti" class="infoinput"  value="<?php echo $xc['meiti'];?>" style="width:300px"/></td>
    <td align="right" class="infotitle">媒体级别：</td>
