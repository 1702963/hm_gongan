...
<input type="hidden" value="gaojian" name="c">
<input type="hidden" value="lists" name="a">
<input type="hidden" value="<?php echo $status;?>" name="status">
<div class="explain-col"> 
  快速工具:   稿件库管理 &nbsp;  
  <a href="?m=xuanchuan&c=gaojian&a=addgj">
...
<table width="100%" border="0">
  <tr>
    <td height="30">
  稿件名称: <input type="text" value="<?php echo $tagname?>" class="input-text" size="6" name="tagname">&nbsp;&nbsp;
...
<table width="100%" cellspacing="0" class="kotable">
	...
	<tr>
      <th width='80'>序号</th>
      <th width="315">稿件标题</th>
      <th width="120">作者</th>
	  <th width='166'>上报人</th>
	  <th width="182">上报单位</th>
	  <th width="179">上报时间</th>
      <th width="187">稿件类型</th>
...
if(is_array($xclist)){
	...
	<tr>
	  ...
	  ?></td>
      <td>
         <a href="index.php?m=xuanchuan&c=gaojian&a=showgj&id=<?php echo $info['id']?>&status=<?php echo $status;?>">查看</a>
        
        &nbsp;<a href="index.php?m=xuanchuan&c=gaojian&a=editgj&id=<?php echo $info['id']?>&status=<?php echo $status;?>">修改</a>
        
        &nbsp;<a href="index.php?m=xuanchuan&c=gaojian&a=tozips&id=<?php echo $info['id']?>&status=<?php echo $status;?>" onclick="javascript:var r = confirm('导出稿件执行负载大，请谨慎执行');if(!r){return false;}">导出稿件</a>
        
        &nbsp;<a href="index.php?m=xuanchuan&c=gaojian&a=zuofei&dofei=1&ids=<?php echo $info['id']?>&status=<?php echo $status;?>" onclick="javascript:var r = confirm('确认作废当前记录吗？');if(!r){return false;}">作废</a>    
      </td>
	</tr>
