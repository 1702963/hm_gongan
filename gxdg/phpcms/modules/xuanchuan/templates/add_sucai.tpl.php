...
<form action="?m=xuanchuan&c=sucai&a=addsc" method="POST" name="myform" id="myform">
...
['Source','-','Templates'],
  ...
  <tr>
    ...
    <td><input type="text" name="in[meiti]" id="meiti" class="infoinput"  value="<?php echo $jd['shbz'];?>" style="width:300px"/></td>
