...
<form action="?m=xuanchuan&c=gaojian&a=addgj" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    ...
    <td width="172" class="rb"><?php echo form::date('in[sbdt]',date("Y-m-d"),0,0,'false')?></td>
    </tr>
  <tr>
...
<input type="text" id="sbren" name="in[sbren]" value="<?php echo $xc['sbren'];?>" class="infoinput" />
  ...
  <tr>
    ...
    <td><select name="in[caiyong]" class="infoselect">
        <?php foreach($tagsp[2] as $v){?>
         <option value="<?php echo $v['name']?>" <?php if($v['name']=="未采纳"){?>selected="selected"<?php }?> ><?php echo $v['name']?></option>
        <?php }?>
      </select></td>
    <td align="right" >&nbsp;</td>
    <td></td>
  ...
  <tr>
    ...
    <td width="246"><input type="text" name="in[meiti]" id="meiti" class="infoinput"  value="<?php echo $jd['shbz'];?>" style="width:90%"/></td>
    ...
    <td><?php echo form::date('in[cydt]',date("Y-m-d"),0,0,'false')?></td>
  </tr>
  <tr>
