...
<input type="hidden" value="xuanchuan" name="m">
<input type="hidden" value="tongji" name="c">
<input type="hidden" value="ndtongji" name="a">
<input type="hidden" value="<?php echo $status;?>" name="status">
<div class="explain-col"> 
<table width="100%" border="0">
  ...
  统计区间: <select name="nd">
             <?php for($i=2025;$i<2030;$i++){?>
               <option value="<?php echo $i?>" <?php if($i==$nown){?>selected="selected"<?php }?>> <?php echo $i?> </option>
             <?php }?>
           </select>  
...
if(is_array($bmarr)){
	...
	foreach($bmarr as $k=>$v){
	 	...
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=1 and zzdwid=$k ",'count(*) as hj');
        $_sc1=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=1 and zzdwid=$k ",'count(*) as hj');
        $_gj1=$tjrs['hj'];
				
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=2 and zzdwid=$k ",'count(*) as hj');
        $_sc2=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=2 and zzdwid=$k ",'count(*) as hj');
        $_gj2=$tjrs['hj'];	
		
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=3 and zzdwid=$k ",'count(*) as hj');
        $_sc3=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=3 and zzdwid=$k ",'count(*) as hj');
        $_gj3=$tjrs['hj'];
		
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=4 and zzdwid=$k ",'count(*) as hj');
        $_sc4=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=4 and zzdwid=$k ",'count(*) as hj');
        $_gj4=$tjrs['hj'];
		
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=5 and zzdwid=$k ",'count(*) as hj');
        $_sc5=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=5 and zzdwid=$k ",'count(*) as hj');
        $_gj5=$tjrs['hj'];
		
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=6 and zzdwid=$k ",'count(*) as hj');
        $_sc6=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=6 and zzdwid=$k ",'count(*) as hj');
        $_gj6=$tjrs['hj'];								
							
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=7 and zzdwid=$k ",'count(*) as hj');
        $_sc7=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=7 and zzdwid=$k ",'count(*) as hj');
        $_gj7=$tjrs['hj'];
		
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=8 and zzdwid=$k ",'count(*) as hj');
        $_sc8=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=8 and zzdwid=$k ",'count(*) as hj');
        $_gj8=$tjrs['hj'];
		
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=9 and zzdwid=$k ",'count(*) as hj');
        $_sc9=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=9 and zzdwid=$k ",'count(*) as hj');
        $_gj9=$tjrs['hj'];
		
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=10 and zzdwid=$k ",'count(*) as hj');
        $_sc10=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=10 and zzdwid=$k ",'count(*) as hj');
        $_gj10=$tjrs['hj'];
		
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=11 and zzdwid=$k ",'count(*) as hj');
        $_sc11=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=11 and zzdwid=$k ",'count(*) as hj');
        $_gj11=$tjrs['hj'];
		
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='素材' and sbns=$nown and sbms=12 and zzdwid=$k ",'count(*) as hj');
        $_sc12=$tjrs['hj'];
	 	$tjrs = $this->db->get_one(" isok=1 and dbtype='稿件' and sbns=$nown and sbms=12 and zzdwid=$k ",'count(*) as hj');
        $_gj12=$tjrs['hj'];																		
		?>
 ...
 <table width="100%" border="0">
  <tr>
    <td>素材</td>
    <td><?php echo $_sc10?></td>
  </tr>
  <tr>
    <td>稿件</td>
    <td><?php echo $_gj10?></td>
  </tr>
</table>      
      </td>
	  <td>
 <table width="100%" border="0">
  <tr>
    <td>素材</td>
    <td><?php echo $_sc11?></td>
  </tr>
  <tr>
    <td>稿件</td>
    <td><?php echo $_gj11?></td>
  </tr>
</table>      
      </td>
  ...
  <tr>
    <td>素材</td>
    <td><?php echo $_sc12?></td>
  </tr>
  <tr>
    <td>稿件</td>
    <td><?php echo $_gj12?></td>
  </tr>
</table></td>
      </tr>
