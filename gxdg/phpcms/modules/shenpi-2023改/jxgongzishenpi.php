...
class jxgongzishenpi extends admin {
	var $db;
	...
	public function init() { //主列表
		  ...
		  $msgs = $this->db->select(" yuan='绩效工资' ".$where,"*","","id desc");
			
		include $this->admin_tpl('jxgongzi_main');
	}
	...
	public function bmuser() { //部门审核
		...
		//考核等级
		  ...
		  $this->db->table_name = 'mj_gongzi_jixiao';
			 ...
			 $where.=" bmuser=".$_SESSION['userid']." and yue=".$_GET['yues']; 
	...
	public function zguser() { //主管领导审核
		...
		//考核等级
		  ...
		  $where.=" zguser=".$_SESSION['userid']." and bmid=".intval($_GET['bmid'])." and yue=".$_GET['yues']; 
	...
	public function zzcuser() { //政治处主任审核
		...
		include $this->admin_tpl('jxgongzi_shlist');
	}	
	...
	public function jxgongzishenpi_do() { //审核操作
		...
		include $this->admin_tpl('jxgongzi_shenqing_do');
	}	
