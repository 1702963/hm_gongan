...
<div class="cat_total">
	<div class="cat_total_con ra"><div class="tcon"><span><a href="index.php?m=shenpi&c=cengjishenpi&a=biandonglits" style="color:#ffffff">层级变动申请</a></span></div></div>
    <div class="cat_total_con ra"><div class="tcon"><span><a href="index.php?m=shenpi&c=cengjishenpi&a=init" style="color:#ffffff">返回上级</a></span></div></div>
</div>
<div class="sys_info">
	<div class="sys_info_title">层级变动审批记录</div>
