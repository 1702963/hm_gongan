...
//数据统计
		...
		$fj_zz = $this->db->get_one('status=1 and isok=1', 'count(id) as zj');
...
<div class="cat_total">
	<div class="cat_total_con ra"><div class="tcon"><span>当前辅警数量</span><b><?php echo $fj_zz['zj']?></b></div></div>
    <div class="cat_total_con rb"><div class="tcon"><span>待培训人数</span><b>0</b></div></div>
    <div class="cat_total_con rc"><div class="tcon"><span>年度新增人数</span><b><?php echo $fj_xz['zj']?></b></div></div>
    <div class="cat_total_con rd"><div class="tcon"><span>年度离职人数</span><b><?php echo $fj_lz['zj']?></b></div></div>
</div>
