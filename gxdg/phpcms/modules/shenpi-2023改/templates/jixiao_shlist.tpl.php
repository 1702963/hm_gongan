...
<div class="table-list" style="scroll-x:auto">
    ...
    <div style=" width:100%;font-size:16px; text-align:center; margin-bottom:5px"><b>辅警<?php $dys=$_GET['yues']."01"; echo date("Y年m月",strtotime($dys))?>绩效考核表</b> &nbsp;<input type="button" name="but1" value="审核绩效考评" style="border-radius:.4em;cursor:pointer; width:100px; height:25px; background-color:#06C; color:#FFF;display:<?php echo $noshow?>" onclick="bmshenhe_do('<?php echo $_GET['yues']?>','<?php echo $_GET['doty']?>','<?php echo $show_table[0]['bmid']?>','<?php echo $_GET['msgid']?>')" <?php echo $buttoncan?>/><?php echo $yishenpi?></div>
