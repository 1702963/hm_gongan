...
<form action="?m=shenpi&c=renyuanshenpi&a=bmsh" method="POST" name="myform" id="myform" >
...
<table cellpadding="0" cellspacing="0" class="baseinfo">
  ...
  <tr>
    ...
    <td width="59%" align="left"  style="border-bottom:0px"><?php echo form::select(array(9=>'同意',2=>'不同意'),9,'name=bmstatus   ')?></td>
  </tr>
   <tr>
    <td align="right" class="infotitle" style="padding-left:20px;border-bottom:0px">上报分管领导：</td>
    <td align="left" class="infotitle" style="border-bottom:0px"><?php echo form::select($ld,'','name=fgshid   ')?></td>
  </tr>
</table>
</div>
