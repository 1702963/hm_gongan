...
function xuan(){
	...
	$.ajax({
             url : "?m=shenpi&c=cengjishenpi&a=chafj", //后台查询验证的方法
             data :"fjid="+uuu, //携带的参数
             type : "get",
			 datatype : "json",
		async:'false',
             success : function(msg) {
				...
				$("#oldcj").empty();
				 ...
				 $("#oldcj").append("<option value='"+obj.cjid+"'>"+obj.cjname+"</option>");
             }
         });
	}
...
<form action="?m=shenpi&c=cengjishenpi&a=gwbd" method="POST" name="myform" id="myform" onsubmit="return check();">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center" >
  <tr>
    ...
    <td width="306"><select id="bmid" name="danwei" style="height:30px" class="infotitle" >
...
<table cellpadding="0" cellspacing="0" class="baseinfo">
  ...
  <tr>
    <td width="13%" align="right" class="infotitle" style="padding-left:20px;border-bottom:0px">原层级：</td>
    <td width="87%" align="left"  style="border-bottom:0px"> <select name="info[oldcj]" id="oldcj" class="infoinput" style="height:30px"></select>
					 </td>
  </tr>
  <tr>
    <td align="right" class="infotitle" style="padding-left:20px;border-bottom:0px">申请变更层级：</td>
    <td align="left"  style="border-bottom:0px">
    <select name="info[newcj]" class="infoinput" style="height:30px">
  ...
  <tr>
    <td align="right" class="infotitle" style="padding-left:20px;border-bottom:0px">变更原因：</td>
