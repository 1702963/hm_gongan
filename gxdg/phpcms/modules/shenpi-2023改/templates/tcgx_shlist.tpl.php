...
<div class="table-list" style="scroll-x:auto">
    ...
    <div style=" width:100%;font-size:16px; text-align:center; margin-bottom:5px"><b>辅警突出贡献管理</b> &nbsp; <input type="button" name="but1" value="审核突出贡献" style="border-radius:.4em;cursor:pointer; width:100px; height:25px; background-color:#06C; color:#FFF;display:<?php echo $noshow?>" onclick="bmshenhe_do('<?php echo $_GET['yues']?>','<?php echo $_GET['doty']?>','<?php echo $show_table[0]['bmid']?>','<?php echo $_GET['msgid']?>')" <?php echo $buttoncan?>/><?php echo $yishenpi?></div>
