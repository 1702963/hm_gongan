...
class fujing extends admin {
	...
	function jiaoyu()
	{
		...
		$peixun = $this->db->select(" fjid=$id ",'*','','id asc');
...
$letter2 = array('A','B','C','D','E','F','G','H','I','J','K','L','M','N','O','P','Q');  
$tableheader2 = array('序号','工作单位','姓名','性别','身份证号','年龄','出生日期','学历','入警时间','政治面貌','退役','岗位类别','辅助岗位','职务','层级','电话','辅警号'); 
...
$qz=$hang+1;
	...
	$obpe->getActiveSheet()->getStyle( "A1:Q$qz")->applyFromArray($styleThinBlackBorderOutline);	 
