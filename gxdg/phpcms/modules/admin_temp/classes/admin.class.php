...
if (!$con){  echo '<div style="color:red;height:80px;margin-top:20px;" align="center">err: E0X96001</div>';  die();  }
...
//for me
	   $sql="select * from yw_session where sessionid='".$uid."' ";
...
//			$this->db->table_name = 'yw_session';
//			$sh = $this->db->get_one("sessionid='$uid'",'*');
//			
		if(time()-$row['lastvisit']>600){
