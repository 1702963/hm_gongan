...
<form name="myform" action="?m=admin&c=role&a=listorder" method="post">
    <table width="100%" cellspacing="0">
        <thead>
		<tr>
		<th width="9%"><?php echo L('userid')?></th>
		<th width="9%" align="left" ><?php echo L('username')?></th>
		<th width="9%" align="left" ><?php echo L('userinrole')?></th>
		<th width="9%"  align="left" ><?php echo L('lastloginip')?></th>
		<th width="18%"  align="left" ><?php echo L('lastlogintime')?></th>
		<th width="12%"  align="left" ><?php echo L('email')?></th>
		<th width="9%"><?php echo L('realname')?></th>
        <th width="9%">所属处室</th>
...
?>
<tr>
<td width="9%" align="center"><?php echo $info['userid']?></td>
<td width="9%" ><?php echo $info['username']?></td>
<td width="9%" ><?php echo $roles[$info['roleid']]?></td>
<td width="9%" ><?php echo $info['lastloginip']?></td>
<td width="18%"  ><?php echo $info['lastlogintime'] ? date('Y-m-d H:i:s',$info['lastlogintime']) : ''?></td>
<td width="12%"><?php echo $info['email']?></td>
<td width="9%"  align="center"><?php echo $info['realname']?></td>
<td width="9%"  align="center"><?php echo $danwei[$info['dwid']]?></td>
<td width="16%"  align="center">
<a href="javascript:edit(<?php echo $info['userid']?>, '<?php echo new_addslashes($info['username'])?>')"><?php echo L('edit')?></a> | 
<?php if(!in_array($info['userid'],$admin_founders)&&$info['userid']!=10) {?>
