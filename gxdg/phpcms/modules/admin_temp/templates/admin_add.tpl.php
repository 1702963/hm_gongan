...
<td>职务</td>
<td>
<input type="text" name="info[zhiwu]" value="" class="input-text" id="zhiwu"></input>
</td>
</tr>
<tr>
<td>联系电话</td>
<td>
<input type="text" name="info[tel]" value="" class="input-text" id="tel"></input>
</td>
</tr>
<tr>
...
<tr>
	  <td>所属处室:</td>
	  <td><?php echo form::select($danwei,'1','name=info[dwid] class=default')?></td>
