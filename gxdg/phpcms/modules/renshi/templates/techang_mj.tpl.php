...
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			...
			<th width="5%" align="center"  style="background-color:#1d1e72" >序号</th>	
		  <th width='25%' align="center" style="background-color:#1d1e72">特长类型</th>
          <th width='25%' align="center" style="background-color:#1d1e72">特长详情</th>
          <th width='25%' align="center" style="background-color:#1d1e72">证明材料</th>
			<th width='15%' align="center" style="background-color:#1d1e72">操作 </th>
...
<tbody>
  ...
  <input type="hidden" name="m" value="renshi" />
  <input type="hidden" name="c" value="renshi" />
  <input type="hidden" name="a" value="techang_mj" />
...
if(is_array($peixun)){
	...
	<tr>
		...
		<td align="center" ><a href="index.php?m=renshi&c=renshi&a=techang&id=<?php echo $_GET['id']?>&dofei=<?php echo $info['id']?>" onclick="javascript:var r = confirm('确认作废当前记录吗？');if(!r){return false;}">作废</a></td>
	</tr>
	<?php
	$i++;}
}
