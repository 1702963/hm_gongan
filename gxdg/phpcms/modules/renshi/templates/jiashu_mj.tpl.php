...
<table width="100%" cellspacing="0" class="kotable">
	<thead>
		<tr>
			...
			<th width='208' align="center">与民警关系</th>
...
<form action="?m=renshi&c=renshi&a=addjiashu_mj" method="POST" name="myform" id="myform">
<table width="966" cellpadding="2" cellspacing="1" class="table_form">
	...
	<tr>
		...
		<td width="36%"><input type="input" name="info[sfz]"  style="width:250px;" /></td>
	</tr>
	...
	<tr>
		<td width="11%"><strong>与民警关系：</strong></td>
...
function att_delete(obj,aid){
	...
	function(){
	$.get('?m=renshi&c=renshi&a=deletejiashu_mj&id='+aid+'&pc_hash=<?php echo $_SESSION['pc_hash']?>',function(data){
