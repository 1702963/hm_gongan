...
<table width="100%" cellspacing="0" class="kotable">
	<thead>
		<tr>
			<th width='813' align="center">表彰内容</th>
			<th width='348' align="center">表彰时间</th>
...
<form action="?m=renshi&c=renshi&a=addbiaozhang_mj" method="POST" name="myform" id="myform">
<table width="966" cellpadding="2" cellspacing="1" class="table_form">

	<tr>
		<td width="11%" height="37"><strong>表彰内容：</strong></td>
		<td width="51%"><input type="input" name="info[content]"  style="width:400px;" /></td>
		<td width="12%"><strong>表彰时间：</strong></td>
...
function att_delete(obj,aid){
	...
	function(){
	$.get('?m=renshi&c=renshi&a=deletebiaozhang_mj&id='+aid+'&pc_hash=<?php echo $_SESSION['pc_hash']?>',function(data){
