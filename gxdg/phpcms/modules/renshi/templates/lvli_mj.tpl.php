...
<tbody>
  ...
  <input type="hidden" name="a" value="lvli_mj" />
...
if(is_array($peixun)){
	...
	<tr>
		...
		<td align="center" ><a href="index.php?m=renshi&c=renshi&a=lvli_mj&id=<?php echo $_GET['id']?>&dofei=<?php echo $info['id']?>" onclick="javascript:var r = confirm('确认作废当前记录吗？');if(!r){return false;}">作废</a></td>
	</tr>
	<?php
	$i++;}
}
