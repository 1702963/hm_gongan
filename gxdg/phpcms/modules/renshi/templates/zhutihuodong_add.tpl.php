...
<form action="?m=renshi&c=geren&a=addsx4_addsave" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    ...
    <td colspan="5">
      <input type="text" name="info[theme]" id="theme" value="" required style="width:500px;height:20px;background:transparent;color:#fff;border:1px solid #ddd;margin-left:5px;text-indent:1px" placeholder="请输入主题"/>
    </td>
  </tr>
  <tr>
    <td align="right" class="infotitle">时间：</td>
    <td colspan="5">
      <input type="date" name="info[content_time]" id="content_time" value="" style="width:300px;height:20px;background:transparent;color:#fff;border:1px solid #ddd;margin-left:5px;text-indent:1px"/>
    </td>
  </tr>
  <tr>
    <td align="right" class="infotitle">正文：</td>
    <td colspan="5">
      <textarea name="info[neirong]" id="neirong" style="width:600px;height:200px;background:transparent;color:#fff;border:1px solid #ddd;margin-left:5px;padding:5px" placeholder="请输入正文内容"></textarea>
    </td>
  </tr>
  <tr>
