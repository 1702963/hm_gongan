...
<table width="100%" cellspacing="0" class="kotable">
	<thead>
		<tr>
			<th width='813' align="center">惩戒内容</th>
			<th width='348' align="center">惩戒时间</th>
...
<form action="?m=renshi&c=renshi&a=addchengjie_mj" method="POST" name="myform" id="myform">
...
function att_delete(obj,aid){
	...
	function(){
	$.get('?m=renshi&c=renshi&a=deletechengjie_mj&id='+aid+'&pc_hash=<?php echo $_SESSION['pc_hash']?>',function(data){
