...
<form action="?m=renshi&c=geren&a=addsx" method="POST" name="myform" id="myform">

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">分局党委介绍</div>
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    <td width="100" align="right" class="infotitle">党委介绍正文：</td>
    <td colspan="5">
      <textarea name="info[neirong]" id="neirong"
                ...
                placeholder="请输入党委介绍正文"><?php echo isset($this->info['neirong']) ? $this->info['neirong'] : ''?></textarea>
    </td>
  </tr>
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=renshi&c=geren&a=upload_dangwei_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
