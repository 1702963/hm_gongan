...
class gonghui extends admin {
	var $db;
	public function __construct() {
		$this->db = pc_base::load_model('opinion_model');
		$this->db->table_name = 'mj_youfu_gonghui';
		pc_base::load_app_func('global');
	}
	
	public function init() {
							
		include $this->admin_tpl('gonghui_list');
	}
	
		
	public function addgh() {
							
		include $this->admin_tpl('add_ghshenbao');
	}	

	public function editgh() {
							
		include $this->admin_tpl('edit_ghshenbao');
	}	
	
	public function hylist() {
							
		include $this->admin_tpl('gonghuihy_list');
	}		
