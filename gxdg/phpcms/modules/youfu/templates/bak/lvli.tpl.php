...
if(is_array($peixun)){
	...
	<tr>
		...
		<td align="center" ><a href="index.php?m=fujing&c=fujing&a=lvli&id=<?php echo $_GET['id']?>&dofei=<?php echo $info['id']?>" onclick="javascript:var r = confirm('确认作废当前记录吗？');if(!r){return false;}">作废</a></td>
	</tr>
	<?php
	$i++;}
}
