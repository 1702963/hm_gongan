...
<input type="hidden" value="gonghui" name="c">
<input type="hidden" value="hylist" name="a">
<input type="hidden" value="<?php echo $status;?>" name="status">
<div class="explain-col"> 
  快速工具:   工会会员 &nbsp;  
  
  <a href="?m=youfu&c=gonghui&a=init">
  <input type="button" value="工会数据" class="button" name="dook"></a> &nbsp;
...
<table width="100%" border="0">
  <tr>
    <td height="30">
  会员姓名: <input type="text" value="<?php echo $tagname?>" class="input-text" size="6" name="tagname">&nbsp;&nbsp;
...
<table width="100%" cellspacing="0" class="kotable">
	...
	<tr>
      <th width='58'>序号</th>
      <th width="136">会员姓名</th>
	  <th width='649'>所在单位</th>
	  <th width='381'>会员卡号</th>
	  <th width='268'>入会员时间</th>
	  <th width="257">会员卡状态</th>
	  <th width="109">操作</th>
	</tr>
    </thead>
    <tbody>
...
if(is_array($bzlist)){
	...
	<tr>
      ...
      <td align="left"><input name="hykh" value="<?php echo $info['kahao']?>" /></td>
      <td align="left"><input name="hydt" value="<?php if($info['hydt']>0){echo date("Y-m-d",$info['hydt']);}?>" /></td>
      <td align="left"><?php echo "正常"; ?></td>
      <td>
        <a href="?m=youfu&c=gonghui&a=editgh&id=<?php echo $info['id']?>"><input type="button" value="处理" class="button"></a>   
      </td>
	</tr>
