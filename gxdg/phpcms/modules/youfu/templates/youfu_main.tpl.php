...
$this->db->table_name = 'mj_youfu_zhengce';
$tjrs = $this->db->get_one(" isok=1 ",'count(*) as hj');
...
$_benweek=date("w");
/// 已发表
$this->db->table_name = 'mj_youfu_fengxian';
$tjrs = $this->db->get_one(" isok=1 and ns=$_bennian ",'count(*) as hj');
if($tjrs['hj']>0){$tjrs['hj']+=1;}
$_fbzs= $tjrs['hj'];
...
$this->db->table_name = 'mj_youfu_tijian';
$tjrs = $this->db->get_one(" xy='1' ",'count(*) as hj');
if($tjrs['hj']>0){$tjrs['hj']+=1;}
$_tjxy= $tjrs['hj'];

$this->db->table_name = 'mj_youfu_tijian';
$tjrs = $this->db->get_one(" xinz='1' ",'count(*) as hj');
if($tjrs['hj']>0){$tjrs['hj']+=1;}
$_tjxinz= $tjrs['hj'];

$this->db->table_name = 'mj_youfu_tijian';
$tjrs = $this->db->get_one(" jj='1' ",'count(*) as hj');
if($tjrs['hj']>0){$tjrs['hj']+=1;}
$_tjnz= $tjrs['hj'];

//本月生日
$this->db->table_name = 'mj_fujing';
$tjsr = $this->db->select(" status=1 and sr_yue=$_benyue ",'id,xingming,dwid,shengri');
$_bysr=count($tjsr);


		$this->db->table_name = 'mj_bumen';
		$rss = $this->db->select("",'id,name','','');
		foreach($rss as $aaa){
			$bms[$aaa['id']]=$aaa['name'];
			}	
?>
...
//1、由于英文字体Acens显示逗号时窄数字1与其他数字有差异，所以暂时改用KeepCal字体；
	...
	var ArrayWrapData = [
		...
		['xiujiarenshu ', <?php echo $_bysr?>],          // 休假人数
		['gerenshixiangtianbao', <?php echo $_wczs?>], // 个人事项同填报
		['benyuebiaozhang', <?php echo $_tjzs?>],        // 本月表彰人数
		['wenmingbiaobing', <?php echo $_tjxy?>],       // 文明标兵
		['weixiaozhixing', <?php echo $_tjxy?>],        // 微笑之星
		['youxiuwanggeyuan', <?php echo $_tjxinz?>],       // 优秀网格员
		['benyuetongbaorenshu', <?php echo $_tjnz?>]     // 本月通报人数
	];
	//数字过渡效果
...
.modEcharts , .modEchartsPie {min-height:440px; background:rgba(10,80,180,0.2);  border:1px solid rgba(10,60,160,0.5); border-radius:3px}
.modEcharts {width:calc( 95% - 30px ); height:calc( 55vh - 50vh );  margin:0 30px 0 0}
.modEchartsPie {width:calc( 95% - 30px ); height:calc( 30vh - 1vh ); margin:20px 0 0 0}
</style>
...
<div class="tableContent">
	<div class="DigitalContent">
            ...
            <div class="modItemContent">
            	...
            	<div class="DataItem" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">政策库</div>
            	...
            	<div class="DataItem" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">工会会员</div>
            	...
            	<div class="DataItem" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">风险上报</div>
            	...
            	<div class="DataItem" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">本月生日</div>
        ...
        <!--表彰督导模块-->
        <div id="modHonour" style="display:">
            <div class="modItemContent">
                ...
                <div class="DataHonour" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">2024年度体检</div>
                ...
                <div class="DataHonour" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">3项以上异常</div>
                ...
                <div class="DataHonour" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">血压异常</div>
                ...
                <div class="DataHonour" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">心脏异常</div>
                ...
                <div class="DataHonour" data-scroll-reveal="enter right">
                    ...
                    <div class="DataItems" data-scroll-reveal="wait .4s enter right">
                        <div class="DataItemName">囊肿/结节</div>
        ...
        <div class="modItemContent">
	        <div class="modEcharts" data-scroll-reveal="enter left" id="buMen">
            
            </div>
        </div>
        <div class="clear"></div>
    <div class="modItemContent" style="height:210px; display:none">    
            <div class="modEchartsPie" data-scroll-reveal="enter right">
            <?php if(count($_bysr)>0){
				?>
            <table width="100%" border="0">
  <tr>
    <td align="left" style="color:#ffffff; font-size:18px">&nbsp; 本月生日</td>
    </tr>
  </table>
 <div style="height:250px; overflow:hidden;overflow-x: hidden;overflow-y: scroll;">
  
  <?php foreach($tjsr as $v){?>
                <div class="DataHonour" data-scroll-reveal="enter right">
