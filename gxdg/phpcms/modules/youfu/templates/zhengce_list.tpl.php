...
<div class="explain-col"> 
  快速工具:   政策资源库 &nbsp;  
  <a href="?m=youfu&c=zhengce&a=addzc">
...
<input type="hidden" value="youfu" name="m">
<input type="hidden" value="zhengce" name="c">
<input type="hidden" value="init" name="a">
<input type="hidden" value="<?php echo $status;?>" name="status">
<div class="explain-col"> 
<table width="100%" border="0">
  <tr>
    <td height="30">
  政策名称: <input type="text" value="<?php echo $tagname?>" class="input-text" size="6" name="tagname">&nbsp;&nbsp;
  政策类目：<select name="tagsid">
...
<table width="100%" cellspacing="0" class="kotable">
	...
	<tr>
      <th width='107'>序号</th>
      <th width="275">政策类目</th>
	  <th width='795'>标题</th>
	  <th width="326">发布时间</th>
...
if(is_array($bzlist)){
	...
	<tr>
      ...
      <td><?php echo $info['zcleixing']?></td>
      <td align="left"><?php echo $info['title']?></td>
	  <td><?php echo date("Y-m-d",$info['zcleixing'])?></td>
      <td><?php if($info['isok']==1){echo "启用";}else{echo "禁用";}?></td>
      <td>
         <a href="?m=youfu&c=zhengce&a=editzc&id=<?php echo $info['id']?>"><input type="button" value="编辑" class="button"></a>   
      </td>
	</tr>
