...
<form action="?m=youfu&c=youfu&a=editsb" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo">
  ...
  <tr>
    ...
    <td width="353"><?php if($xc['bjdt']==0){$xc['bjdt']=time();} echo form::date('in[bjdt]',date("Y-m-d",$xc['bjdt']),0,0,'false')?></td>
    <td width="123" align="right" class="infotitle">发放金额：</td>
    <td width="361"><input type="text" name="in[sfje]" id="sfje" class="infoinput"  value="<?php echo $xc['sfje'];?>" style="width:300px"/></td>
  </tr>
  <tr>
