...
class fengxian extends admin {
	...
	public function init() {
		...
		include $this->admin_tpl('fengxian_list');
	}
	
	public function addfx() {
							
		include $this->admin_tpl('add_fengxian');
	}	

	public function editfx() {
							
		include $this->admin_tpl('edit_fengxian');
	}
