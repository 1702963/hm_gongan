...
<form action="?m=dangjian&c=jiagou&a=guanxibiandong_addsave" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    ...
    <td colspan="5">
      <input type="date" name="info[biandong_date]" id="biandong_date" value=""
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="text" name="info[yuan_suozaidi]" id="yuan_suozaidi" value=""
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="text" name="info[xian_suozaidi]" id="xian_suozaidi" value=""
             style="width:500px;height:20px;background:transparent;color:#fff;border:1px solid #ddd;margin-left:5px;text-indent:1px"
  ...
  <tr>
    ...
    <td colspan="5">
      ...
      <input type="hidden" name="info[renyuan]" id="renyuan" value="" />
