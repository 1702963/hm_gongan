...
<form action="?m=dangjian&c=zhibu&a=tanxintanhua_editsave" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    ...
    <td colspan="5">
      ...
      <input type="hidden" name="info[tanhua_renyuan]" id="tanhua_renyuan" value="<?php echo $this->info['tanhua_renyuan']?>" />
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=dangjian&c=zhibu&a=upload_tanxintanhua_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
$(function(){
    // 初始化已选人员（从隐藏字段加载）
    var existingValue = $('#tanhua_renyuan').val();
