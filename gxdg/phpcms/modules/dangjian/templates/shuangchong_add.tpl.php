...
<form action="?m=dangjian&c=chengyuan&a=sczz_addsave" method="POST" name="myform" id="myform">
  ...
  <tr>
    ...
    <td colspan="5">
      <select name="info[huiyi_type]" id="huiyi_type" class="infoselect" required
        ...
        <option value="分局党委会">分局党委会</option>
        <option value="理论中心组学习会">理论中心组学习会</option>
        <option value="民主生活会">民主生活会</option>
        <option value="党支部生活会">党支部生活会</option>
        <option value="党支部党员大会">党支部党员大会</option>
        <option value="党支部党小组会">党支部党小组会</option>
        <option value="党支部党课">党支部党课</option>
