...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    ...
    <td colspan="5">
      <input type="text" id="basexm" value="<?php echo $info['xingming']?> [<?php echo $info['sex']?>, <?php echo $info['sfz']?>]"
             ...
             style="width:500px;background:#1a2a4a;color:#fff"/>
  ...
  <tr>
    ...
    <td width="263">
      <input type="text" name="info[xingming]" id="xingming" value="<?php echo $info['xingming']?>" class="infoinput" style="background:#1a2a4a;color:#fff;border:1px solid #ddd" />
    </td>
    ...
    <td class="rb">
      <input type="text" name="info[sfz]" id="sfz" class="infoinput" value="<?php echo $info['sfz']?>" style="background:#1a2a4a;color:#fff;border:1px solid #ddd"/>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <input type="date" name="info[shengri]" id="shengri" class="infoinput" value="<?php echo $info['shengri']?>"
             style="width:200px;background:#1a2a4a;color:#fff;border:1px solid #ddd" />
    </td>
    <td align="right" class="infotitle">年龄：</td>
    <td>
      <input type="text" name="info[age]" id="age" class="infoinput" value="<?php echo $info['age']?>" style="background:#1a2a4a;color:#fff;border:1px solid #ddd"/>
      <span style="color:#999;font-size:12px">(自动计算)</span>
    </td>
    <td align="right" class="infotitle">电话：</td>
    <td class="rb">
      <input type="text" name="info[tel]" id="tel" class="infoinput" value="<?php echo $info['tel']?>" style="background:#1a2a4a;color:#fff;border:1px solid #ddd"/>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <select name="info[xueli]" id="xueli" class="infoselect" style="background:#1a2a4a;color:#fff;border:1px solid #ddd">
    ...
    <td>
      <input type="text" name="info[zhuanye]" id="zhuanye" class="infoinput" value="<?php echo $info['zhuanye']?>" style="background:#1a2a4a;color:#fff;border:1px solid #ddd"/>
    </td>
    <td align="right" class="infotitle">毕业学校：</td>
    <td class="rb">
      <input type="text" name="info[xuexiao]" id="xuexiao" class="infoinput" value="<?php echo $info['xuexiao']?>" style="background:#1a2a4a;color:#fff;border:1px solid #ddd"/>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="5">
      <select name="info[dwid]" id="dwid" style="background:#1a2a4a;color:#fff;border:1px solid #ddd">
  ...
  <tr>
    ...
    <td>
      <select name="info[gangwei]" id="gangwei" class="infoselect" style="background:#1a2a4a;color:#fff;border:1px solid #ddd">
        <option value="">请选择</option>
    ...
    <td>
      <select name="info[zhiwu]" id="zhiwu" class="infoselect" style="background:#1a2a4a;color:#fff;border:1px solid #ddd">
        <option value="">请选择</option>
    ...
    <td class="rb">
      <select name="info[cengji]" id="cengji" class="infoselect" style="background:#1a2a4a;color:#fff;border:1px solid #ddd">
        <option value="">请选择</option>
