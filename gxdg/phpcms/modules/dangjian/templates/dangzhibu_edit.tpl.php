...
<form action="?m=dangjian&c=jiagou&a=dangzhibu_editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo $this->info['id']?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">党支部活动</div>
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    <td width="100" align="right" class="infotitle"><span style="color:red">*</span>活动主题：</td>
    <td colspan="5">
  ...
  <tr>
    <td align="right" class="infotitle">活动时间：</td>
    <td colspan="5">
      <input type="date" name="info[activity_time]" id="activity_time" value="<?php echo $this->info['activity_time_show']?>"
  ...
  <tr>
    ...
    <td colspan="5">
      <textarea name="info[content]" id="content"
                ...
                placeholder="请输入活动正文内容"><?php echo $this->info['content']?></textarea>
    </td>
  </tr>
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=dangjian&c=jiagou&a=upload_dangzhibu_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
