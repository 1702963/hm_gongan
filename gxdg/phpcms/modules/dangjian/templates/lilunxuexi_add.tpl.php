...
<form action="?m=dangjian&c=jiagou&a=lilunxuexi_addsave" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="date" name="info[study_time]" id="study_time" value=""
  ...
  <tr>
    ...
    <td colspan="5">
      <textarea name="info[content]" id="content"
                ...
                placeholder="请输入学习培训正文内容"></textarea>
    </td>
  </tr>
