...
<form action="?m=dangjian&c=zhibu&a=shenghuohui" method="POST" name="myform" id="myform">

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">组织生活会</div>
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    <td width="100" align="right" class="infotitle">生活会内容：</td>
    <td colspan="5">
      <textarea name="info[neirong]" id="neirong"
                ...
                placeholder="请输入生活会内容"><?php echo isset($this->info['neirong']) ? $this->info['neirong'] : ''?></textarea>
    </td>
  </tr>
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=dangjian&c=zhibu&a=upload_shenghuohui_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
