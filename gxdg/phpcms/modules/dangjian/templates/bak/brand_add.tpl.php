...
<form action="?m=dangjian&c=zhibu&a=brand_addsave" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="date" name="info[create_time]" id="create_time" value=""
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="hidden" name="info[logo]" id="logo" value="" />
