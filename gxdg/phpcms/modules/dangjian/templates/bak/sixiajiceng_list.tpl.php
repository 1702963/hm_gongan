...
<div class="explain-col">
  快速工具:
<a href="index.php?m=dangjian&c=chengyuan&a=sixiajiceng_add"><input type="button" value="添加记录" style="margin-left:10px; width:80px" class="doLock" name="dook"></a>
</div>
...
<table width="100%" cellspacing="4" cellpadding="4" class="kotable">
    ...
    <tr>
      ...
      <th width="120">时间</th>
      <th width="150">地点</th>
      <th width="100">解决问题个数</th>
      <th width="100">服务群众人数</th>
      <th width="80">附件</th>
      <th width="150">操作</th>
    </tr>
    </thead>
...
if(is_array($this->list)){
    ...
    <tr>
      ...
      <td><?php echo $info['activity_time_show']?></td>
      <td><?php echo $info['location']?></td>
      <td><?php echo $info['problem_count']?></td>
      <td><?php echo $info['service_count']?></td>
      <td>
        <?php
        if($info['fujian']){
      ...
      <td>
        &nbsp;<a href="index.php?m=dangjian&c=chengyuan&a=sixiajiceng_edit&id=<?php echo $info['id']?>">编辑</a>
        &nbsp;<a href="index.php?m=dangjian&c=chengyuan&a=sixiajiceng_del&id=<?php echo $info['id']?>" onclick="javascript:var r = confirm('确认删除该记录吗？');if(!r){return false;}">删除</a>
      </td>
    </tr>
   <?php
    $i++;}
