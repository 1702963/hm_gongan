...
<form action="?m=dangjian&c=zhibu&a=zhuanxianggongzuo_editsave" method="POST" name="myform" id="myform">
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=dangjian&c=zhibu&a=upload_zhuanxianggongzuo_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
