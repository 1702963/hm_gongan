...
<form action="?m=dangjian&c=chengyuan&a=sczz_editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo $this->info['id']?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title"  style="width:auto;">双重组织生活情况</div>
  ...
  <tr>
    ...
    <td colspan="5">
      <select name="info[huiyi_type]" id="huiyi_type" class="infoselect" required
        ...
        <option value="民主生活会" <?php echo $this->info['huiyi_type']=='民主生活会'?'selected':''?>>民主生活会</option>
        <option value="党支部生活会" <?php echo $this->info['huiyi_type']=='党支部生活会'?'selected':''?>>党支部生活会</option>
        <option value="党支部党员大会" <?php echo $this->info['huiyi_type']=='党支部党员大会'?'selected':''?>>党支部党员大会</option>
        <option value="党支部党小组会" <?php echo $this->info['huiyi_type']=='党支部党小组会'?'selected':''?>>党支部党小组会</option>
        <option value="党支部党课" <?php echo $this->info['huiyi_type']=='党支部党课'?'selected':''?>>党支部党课</option>
        <option value="其他活动" <?php echo $this->info['huiyi_type']=='其他活动'?'selected':''?>>其他活动</option>
      </select>
    </td>
  </tr>
...
$(function(){
    // 初始化已选人员（从隐藏字段加载）
    var existingValue = $('#canhui_renyuan').val();
