...
<form action="?m=dangjian&c=zhibu&a=zhengzhishengri_editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo $this->info['id']?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">政治生日</div>
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    <td align="right" class="infotitle">政治生日：</td>
    <td colspan="5">
      <input type="date" name="info[zhengzhi_shengri]" id="zhengzhi_shengri" value="<?php echo $this->info['zhengzhi_shengri_show']?>"
             style="width:300px;height:20px;background:#1a2a4a;color:#fff;border:1px solid #ddd;margin-left:5px;text-indent:1px"/>
    </td>
  </tr>
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=dangjian&c=zhibu&a=upload_zhengzhishengri_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
$(function(){
    ...
    var selectedPeople = existingValue ? existingValue.split(',').filter(function(n){ return n.trim() !== ''; }) : [];
