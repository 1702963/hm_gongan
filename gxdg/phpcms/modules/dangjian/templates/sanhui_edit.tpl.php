...
<form action="?m=dangjian&c=zhibu&a=three_editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo $this->info['id']?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">三会一课记录</div>
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=dangjian&c=zhibu&a=upload_sanhui_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
