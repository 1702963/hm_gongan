...
<div class="explain-col">
  快速工具:
<a href="index.php?m=dangjian&c=jiagou&a=dangzhibu_add"><input type="button" value="添加记录" style="margin-left:10px; width:80px" class="doLock" name="dook"></a>
</div>
...
if(is_array($this->list)){
    ...
    <tr>
      ...
      <td>
        &nbsp;<a href="index.php?m=dangjian&c=jiagou&a=dangzhibu_edit&id=<?php echo $info['id']?>">编辑</a>
        &nbsp;<a href="index.php?m=dangjian&c=jiagou&a=dangzhibu_del&id=<?php echo $info['id']?>" onclick="javascript:var r = confirm('确认删除该记录吗？');if(!r){return false;}">删除</a>
      </td>
    </tr>
   <?php
    $i++;}
