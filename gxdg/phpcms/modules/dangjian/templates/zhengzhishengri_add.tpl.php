...
<form action="?m=dangjian&c=zhibu&a=zhengzhishengri_addsave" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    ...
    <td colspan="5">
      <input type="date" name="info[zhengzhi_shengri]" id="zhengzhi_shengri" value=""
             style="width:300px;height:20px;background:#1a2a4a;color:#fff;border:1px solid #ddd;margin-left:5px;text-indent:1px"/>
    </td>
  </tr>
