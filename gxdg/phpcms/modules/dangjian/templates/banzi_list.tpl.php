...
<div class="explain-col">
  快速工具:
<a href="index.php?m=dangjian&c=chengyuan&a=add"><input type="button" value="添加成员" style="margin-left:10px; width:80px" class="doLock" name="dook"></a>
</div>
