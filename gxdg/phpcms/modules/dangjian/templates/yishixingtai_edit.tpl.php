...
<form action="?m=renshi&c=geren&a=addsx3_editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo $this->info['id']?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">意识形态工作</div>
...
$('#canhui_search').on('keyup', function() {
    ...
    searchTimer = setTimeout(function() {
        $.ajax({
            url: 'index.php?m=renshi&c=geren&a=search_fujing_yishixingtai',
            type: 'GET',
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=renshi&c=geren&a=upload_yishixingtai_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
