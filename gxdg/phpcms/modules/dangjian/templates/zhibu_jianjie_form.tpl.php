...
<form action="?m=dangjian&c=zhibu&a=init" method="POST" name="myform" id="myform">

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">党支部简介</div>
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    <td width="100" align="right" class="infotitle">党支部简介：</td>
    <td colspan="5">
      <textarea name="info[jianjie]" id="jianjie"
                ...
                placeholder="请输入党支部简介"><?php echo isset($this->info['jianjie']) ? $this->info['jianjie'] : ''?></textarea>
    </td>
  </tr>
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=dangjian&c=zhibu&a=upload_fujian_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
