...
<form action="?m=dangjian&c=jiagou&a=lilunxuexi_editsave" method="POST" name="myform" id="myform">
<input type="hidden" name="id" value="<?php echo $this->info['id']?>" />

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">参加政治理论学习培训情况</div>
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    <td width="100" align="right" class="infotitle"><span style="color:red">*</span>学习主题：</td>
    <td colspan="5">
  ...
  <tr>
    <td align="right" class="infotitle">学习时间：</td>
    <td colspan="5">
      <input type="date" name="info[study_time]" id="study_time" value="<?php echo $this->info['study_time_show']?>"
  ...
  <tr>
    ...
    <td colspan="5">
      <textarea name="info[content]" id="content"
                ...
                placeholder="请输入学习培训正文内容"><?php echo $this->info['content']?></textarea>
    </td>
  </tr>
  ...
  <tr>
    <td align="right" class="infotitle">个人学习照片：</td>
    <td colspan="5">
      <input type="hidden" name="info[photos]" id="photos" value='<?php echo htmlspecialchars($this->info['photos'])?>' />
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=dangjian&c=jiagou&a=upload_lilunxuexi_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
