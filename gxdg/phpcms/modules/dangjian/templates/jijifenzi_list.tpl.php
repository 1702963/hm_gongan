...
<div class="explain-col">
  快速工具:
<a href="index.php?m=dangjian&c=jiagou&a=jijifenzi_add"><input type="button" value="添加入党积极分子" style="margin-left:10px; width:120px" class="doLock" name="dook"></a>
</div>
...
if(is_array($this->list)){
    ...
    <tr>
      ...
      <td>
        <a href="index.php?m=dangjian&c=jiagou&a=jijifenzi_edit&id=<?php echo $info['jj_id']?>">编辑</a>
        &nbsp;<a href="index.php?m=dangjian&c=jiagou&a=jijifenzi_del&id=<?php echo $info['jj_id']?>" onclick="javascript:var r = confirm('确认删除该入党积极分子吗？');if(!r){return false;}">删除</a>
      </td>
    </tr>
   <?php
    $i++;}
