...
<form action="?m=dangjian&c=zhibu&a=dangke" method="POST" name="myform" id="myform">

<div class="tableContent">

<div class="tabcon">
<div class="title" style="width:auto;">党课</div>
...
function uploadSingleFile(file) {
    ...
    $.ajax({
        url: 'index.php?m=dangjian&c=zhibu&a=upload_dangke_image',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
