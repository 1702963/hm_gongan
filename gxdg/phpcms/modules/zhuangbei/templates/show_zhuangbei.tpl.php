...
<tr>
	...
	<tr>
		...
		<td colspan="3" ><?php echo form::date('hhtime',date("Y-m-d",$zhuangbei['hhtime']),0,0,'false');?></td>
	  </tr>
	
	<tr>
		<th  height="29" align="right">备注：</th>
		<td colspan="3" ><textarea name="beizhu" rows="1" style="width:90%"><?php echo $zhuangbei['beizhu']?></textarea></td>
	  </tr>
	<tr>
		<th></th>
		<td colspan="3"></td>
