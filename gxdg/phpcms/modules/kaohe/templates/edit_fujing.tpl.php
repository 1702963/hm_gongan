...
<form action="?m=fujing&c=fujing&a=edit" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
   ...
   <tr>
    ...
    <td colspan="3"><input type="text" name="info[shengao]" id="shengao" class="infoinput" value="<?php echo $fujing['shengao'];?>" style="width:50px" onblur="getbmi()"/> 米 &nbsp;&nbsp;体重
...
<?php echo $select_categorys;?>
    ...
    <td colspan="3"><select class="infoselect" name="info[gangweifz]" >       
  ...
  <tr>
    ...
    <td width="178"><select class="infoselect" name="info[gwdj]" > 
                      <option value="0">无</option>      
                     <?php foreach($gwdj as $k=>$v){?>
                     <option value="<?php echo $k?>" <?php if($k==$fujing['gwdj']){?>selected="selected"<?php }?>><?php echo $v?></option>
                     <?php }?>
                    </select></td>
    <td width="81" align="right"><span class="infotitle">入警时间：</span></td>
    <td width="201"><?php echo form::date('rjtime',date("Y-m-d",$fujing['rjtime']),0,0,'false');?></td>
  </tr>
  <tr>
    <td width="90" align="right" class="infotitle">评档时间：</td>
    <td width="230"><?php echo form::date('pingdangtime',date("Y-m-d",$fujing['pingdangtime']),0,0,'false');?></td>
    <td width="90" align="right" class="infotitle">评级时间：</td>
    <td width="230"><?php echo form::date('pingjitime',date("Y-m-d",$fujing['pingjitime']),0,0,'false');?></td>    
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" id="myname2" name="info[kahao]" class="infoinput" value="<?php echo $fujing['kahao'];?>"/></td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" id="myname2" name="info[dfmj]" class="infoinput" value="<?php echo $fujing['dfmj'];?>"/></td>
  ...
  <tr>
    ...
    <td width="90" align="right" class="infotitle">离职时间：</td>
    <td width="230"><?php if(intval($fujing['lizhitime'])<1){$fujing['lizhitime']="";} echo form::date('lizhitime',date("Y-m-d",$fujing['lizhitime']),0,0,'false');?></td>    
    <td width="90" align="right" class="infotitle">离职原因：</td>
    <td colspan="3"><textarea name="lizhiyuanyin" rows="4" style="width:400px;"><?php echo $fujing['lizhiyuanyin'];?></textarea>
    </td>
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" id="myname2" name="info[ddanwei]" class="infoinput" value="<?php echo $fujing['ddanwei'];?>"/></td>
  </tr>
  <tr>
    ...
    <td colspan="3"><?php echo form::date('gzztime',date("Y-m-d",$fujing['gzztime']),0,0,'false');?></td>
  </tr>
  <tr>
    ...
    <tr>
    <td width="90" align="right" class="infotitle">登录密码：</td>
    <td width="230"><input type="text"  name="info[password]" class="infoinput" value="<?php echo $fujing['password'];?>"/></td>
    <td width="90" align="right" class="infotitle"></td>
    <td width="230"></td>    
    <td width="90" align="right" class="infotitle"></td>
    <td colspan="3"></td>
