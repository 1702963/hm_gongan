...
<table cellpadding="0" cellspacing="0" class="baseinfo">
  ...
  <tr>
    ...
    <td width="82" align="right"><span class="infotitle">入警时间：</span></td>
...
function jiashu(id) {
	window.top.art.dialog({title:'家属列表', id:'showme4', iframe:'?m=fujing&c=fujing&a=jiashu&id='+id ,width:'1200px',height:'500px'});
}
...
function prints(id) {
	window.top.art.dialog({title:'打印', id:'showme', iframe:'?m=fujing&c=fujing&a=dao2doc&id='+id ,width:'900px',height:'650px'});
}
</script>
