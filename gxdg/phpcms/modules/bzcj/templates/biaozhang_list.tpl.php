...
<form name="myform" id="myform" action="?m=biaozhang&c=biaozhang&a=listorder" method="POST">
...
function sh(id) {
	window.top.art.dialog({title:'表彰审批', id:'showme2', iframe:'?m=bzcj&c=biaozhang&a=sh&id='+id ,width:'500px',height:'400px'});
}
...
function att_delete(obj,aid){
	...
	function(){
	$.get('?m=bzcj&c=biaozhang&a=delete&id='+aid+'&pc_hash=<?php echo $_SESSION['pc_hash']?>',function(data){
