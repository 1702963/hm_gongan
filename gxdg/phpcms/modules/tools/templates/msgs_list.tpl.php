...
<div class="explain-col"> 
  快速工具:                       
<a href="index.php?m=renshi&c=jlpeizhi&a=sets"><input type="button" value="创建上报模板" style="margin-left:10px; width:90px" class="doLock" name="dook"></a>
		</div>
...
<table width="100%" cellspacing="4" cellpadding="4" class="kotable">
	...
	<tr>
      ...
      <th width='63'>序号</th>
      <th width="120">单位</th>
	  <th width='103'>上报标题</th>
	   <th width="50">上报状态</th>
      <th width="165">开始时间</th>
	  <th width="84">停止时间</th>
      <th width="119">创建人</th>
      <th width="162">填报人</th>
      <th width="103">模板状态</th>  
      <th width="103">创建时间</th>
      <th width="103">管理</th>
      </tr>
    </thead>
    <tbody>
...
if(is_array($list_rs2)){
	...
	<tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td align="center"><a href="#">查看</a>&nbsp;|&nbsp; <a href="#">管理</a>&nbsp;|&nbsp;<a href="#">导出</a></td>
      </tr>
