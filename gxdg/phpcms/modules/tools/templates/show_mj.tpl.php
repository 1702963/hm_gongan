...
<table cellpadding="0" cellspacing="0" class="baseinfo">
  ...
  <tr>
    <td width="123" align="right" class="infotitle">职务：</td>
    <td width="400"><?php echo $zhiwu[$fujing['zhiwu']];?></td>
  ...
  <tr>
    <td width="123" align="right" class="infotitle">在职状态：</td>
    <td width="400"><?php $sss=array(1=>'在职',2=>'离职',3=>'死亡',4=>'退休',5=>'其他');echo $sss[$fujing['status']];?>
      <?php if($fujing['status']==2){echo "&nbsp;离职时间：";if($fujing['lizhitime']!=''){echo date("Y-m-d",$fujing['lizhitime']);}}?></td>
    <td width="84" align="right" class="infotitle">&nbsp;</td>
    <td width="203">&nbsp;</td>    
    <td width="90" align="right" class="infotitle">&nbsp;</td>
    <td>&nbsp;</td>
