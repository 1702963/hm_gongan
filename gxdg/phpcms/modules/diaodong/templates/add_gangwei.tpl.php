...
<div class="pad-lr-10">
<form action="?m=diaodong&c=diaodong&a=addgangwei" method="POST" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		...
		<td width="769"><?php echo form::select($gangwei,'','name=info[newgw] class=infoselect')?></td>
		<td width="788">&nbsp;</td>
	</tr>
	<tr>
