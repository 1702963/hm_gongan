...
<div class="pad-lr-10">
<form action="?m=diaodong&c=diaodong&a=addzaizhi" method="POST" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		<th width="90" height="37">申请变更在职状态：</th>
		<td width="769"><?php echo form::select($sss,'','name=info[newstatus] class=infoselect')?></td>
		<td width="788">&nbsp;</td>
	</tr>
	<tr>
