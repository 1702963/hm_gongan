...
<div class="pad-lr-10">
<form action="?m=diaodong&c=diaodong&a=shzaizhi" method="POST" name="myform" id="myform">
  ...
  <input type="hidden" name="fjid" value="<?php echo $info['fjid'];?>">
  <input type="hidden" name="zhiwu" value="<?php echo $info['newstatus'];?>">
</form>
</div>
</body>
</html>
