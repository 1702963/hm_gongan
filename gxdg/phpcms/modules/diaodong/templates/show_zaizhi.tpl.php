...
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		<th width="286" height="37">原在职状态：</th>
		<td width="1364"><?php echo $sss[$info['oldstatus']];?></td>
	</tr>
	<tr>
		<th width="286" height="37">变更后在职状态：</th>
		<td width="1364"><?php echo $sss[$info['newstatus']];?></td>
	</tr>
