...
<div class="pad-lr-10">
<form action="?m=diaodong&c=diaodong&a=addzhiwu" method="POST" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		<th width="90" height="37">申请变更职务：</th>
		<td width="769"><?php echo form::select($zhiwu,'','name=info[newzw] class=infoselect')?></td>
		<td width="788">&nbsp;</td>
	</tr>
	<tr>
