...
class biaozhang extends admin {
	...
	public function init() {			
		include $this->admin_tpl('mjjl_list');
	}
	
	public function mjjl() {			
		include $this->admin_tpl('mjjl_list');
	}	
	
	public function addmj() {			
		include $this->admin_tpl('add_mj');
	}
	
	public function editmj() {			
	...
	public function wmbb() {			
		include $this->admin_tpl('wmbb_list');
	}	
	
	public function wmbbshow() {			
		include $this->admin_tpl('edit_wmbb');
	}	
	
	public function editwmbb() {			
		include $this->admin_tpl('edit_wmbb');
	}		
		
	public function addwmbb() {			
		include $this->admin_tpl('add_wmbb');
	}	
	
	public function wxzx() {			
		include $this->admin_tpl('wxzx_list');
	}	
	
	public function addwxzx() {			
		include $this->admin_tpl('add_wxzx');
	}		
	
	public function editwxzx() {			
		include $this->admin_tpl('edit_wxzx');
	}	
	
	public function wxzxshow() {			
		include $this->admin_tpl('edit_wxzx');
	}			
	
	public function addyxwgy() {			
		include $this->admin_tpl('add_yxwgy');
	}	
	
	public function yxwgyshow() {			
		include $this->admin_tpl('edit_yxwgy');
	}	
	
	public function edityxwgy() {			
		include $this->admin_tpl('edit_yxwgy');
	}	
	
	public function yxwgy() {			
		include $this->admin_tpl('yxwgy_list');
	}					
	
	public function mjzuofei() {			
		$id = $_GET['ids'];
