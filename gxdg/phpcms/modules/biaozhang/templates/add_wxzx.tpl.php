...
showmessage('操作完成','index.php?m=biaozhang&c=biaozhang&a=wxzx');	
}
...
<!--
	...
	parent.document.getElementById('center_frame').src = '?m=admin&c=bumen&a=bumen_tree&pc_hash=<?php echo $_SESSION['pc_hash'];?>&mm=biaozhang&cc=biaozhang&aa=wxzx&status=<?php echo $status;?>';
...
<form action="?m=biaozhang&c=biaozhang&a=addwxzx" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    ...
    <td><span class="rb">
      <input type="text" name="in[yuedu]" id="yuedu" class="infoinput"  value="<?php echo date("Y-m");?>"/>
    </span></td>
    </tr>
  <tr>
    <td align="right" class="infotitle">获奖励时单位：</td>
    <td width="246"><input type="text" name="in[jldanwei]" id="jldanwei" class="infoinput" value="<?php echo $fujing['hjdizhi'];?>" /></td>
    ...
    <input type="hidden" id="dwid" name="in[dwid]" value="0" class="infoinput" /></td>
...
<div class="tabcon">
<div class="title" style="width:150px">微笑之星</div>

<table cellpadding="0" cellspacing="0" class="baseinfo">
  <tr>
    <td align="right" class="infotitle">批准文件：</td>
    <td width="609"><input type="file" id="zmups" style="display:none" onchange="ufs('zmups')" name="zmup"/>&nbsp;<input type="button" value="上传" style="width:70px" onclick="onfiles('zmups')"/>&nbsp;
    <progress id="prob-zmups" value="0" max="100" style="display:none"></progress></td>
    <td width="706" id="msgs-zmups">&nbsp;</td>
    </tr>
  <tr>
    <td align="right" class="infotitle">已上传材料：</td>
    <td colspan="2" id="uplist-zmups"></td>
  </tr>
  <tr>
    <td width="118" align="right" class="infotitle">简要事迹：</td>
    <td colspan="2"><div id='content_tip'></div><textarea name="in[shiji]" id="content" boxid="content"></textarea><script type="text/javascript" src="statics/js/ckeditor/ckeditor.js"></script><script type="text/javascript">
