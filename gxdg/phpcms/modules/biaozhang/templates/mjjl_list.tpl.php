...
$tuiyi[2]="否";
		...
		$where=" isok=1 and mleixing='民警奖励' ";
		$orders=" id desc ";
...
<div class="explain-col"> 
  快速工具:   民警奖励 &nbsp;                      
<a href="?m=biaozhang&c=biaozhang&a=addmj"><input type="button" value="新增" class="button" name="dook"></a>  
		</div>
</form>
...
<input type="hidden" value="mjjl" name="a">
<input type="hidden" value="<?php echo $status;?>" name="status">
<div class="explain-col"> 
...
<table width="100%" cellspacing="0" class="kotable">
	...
	<tr>
      <th width='71'>序号</th>
      <th width="137">工作单位</th>
	  <th width='117'>姓名</th>
	  <th width="83">性别</th>
      <th width="189">身份证号</th>
	  <th width="135">奖励类别</th>
      <th width="185">批准日期</th>
      <th width="117">批准机关</th>  
      <th width="117">批准文号</th>
      <th width="165">获奖励时单位</th>
      <th width="230">获奖励时职务</th>
      <th width="147">审核</th>
      <th width="153">操作</th>
	</tr>
    </thead>
...
if(is_array($bzlist)){
	...
	<tr>
	  ...
	  <td><?php echo $info['jlleibie']?></td>
      <td><?php echo date("Y-m-d",$info['pzdt'])?></td>
      <td><?php echo $info['pzjg']?></td>
      <td><?php echo $info['pzwh']?></td>
      <td><?php echo $info['jldanwei'];?></td>
      <td><?php echo $info['jlzhiwu'];?></td>
      <td><?php 
	         if($info['shenhe']==0){
				 echo "待审核";
				 }
	  ...
	  ?></td>
      <td><a href="index.php?m=biaozhang&c=biaozhang&a=mjshow&id=<?php echo $info['id']?>&status=<?php echo $status;?>">查看</a>
        
        &nbsp;<a href="index.php?m=biaozhang&c=biaozhang&a=editmj&id=<?php echo $info['id']?>&status=<?php echo $status;?>">修改</a>
        
        &nbsp;<a href="index.php?m=biaozhang&c=biaozhang&a=mjzuofei&dofei=1&ids=<?php echo $info['id']?>&status=<?php echo $status;?>" onclick="javascript:var r = confirm('确认作废当前记录吗？');if(!r){return false;}">作废</a>      
      </td>
	</tr>
   <?php
	$i++;}
