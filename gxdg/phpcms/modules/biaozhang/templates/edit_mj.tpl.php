...
<!--
	...
	parent.document.getElementById('center_frame').src = '?m=admin&c=bumen&a=bumen_tree&pc_hash=<?php echo $_SESSION['pc_hash'];?>&mm=biaozhang&cc=biaozhang&aa=mjjl&status=<?php echo $status;?>';
...
<form action="?m=biaozhang&c=biaozhang&a=editmj" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    <td width="117" align="right" class="infotitle"><span>姓名：</span><input type="hidden" id="uid" name="in[uid]" value="<?php echo $bz['uid']?>" class="infoinput" /></td>
  ...
  <tr>
    ...
    <td><span class="rb">
      <input type="text" name="in[jlzhiwu]" id="jlzhiwu" class="infoinput"  value="<?php echo $bz['jlzhiwu']?>"/>
    </span></td>
    </tr>
  <tr>
    ...
    <input type="hidden" id="dwid" name="in[dwid]" value="<?php echo $bz['dwid']?>" class="infoinput" />
    </td>
  ...
  <tr>
    ...
    <td width="246"><input type="radio" class="rad" <?php if($bz['shenhe']==1){?>checked<?php }?>  name="shenhe"  id="nan" value="1"/>通过
        ...
        &nbsp; <input type="submit" value="审核" style="width:70px;<?php if($_GET['a']!="editmj"){?>display:none;<?php }?>" name="doshenhe"/>
        </td>
    <td width="100" align="right" class="infotitle">审核人</td>
    <td width="211"><?php echo $bz['shuser']?>&nbsp;<?php if($bz['shdt']>0){?>[<?php echo date("Y-m-d H:i:s",$bz['shdt'])?>]<?php }?>
    </td>
...
<table cellpadding="0" cellspacing="0" class="baseinfo">
  <tr>
    ...
    <td width="289"> <select name="in[jlleibie]" id="jlleibie" class="infoselect">
        <option value="嘉奖" <?php if($bz['jlleibie']=="嘉奖"){?>selected<?php }?>>嘉奖</option>
        <option value="三等功" <?php if($bz['jlleibie']=="三等功"){?>selected<?php }?>>三等功</option>
        <option value="二等功" <?php if($bz['jlleibie']=="二等功"){?>selected<?php }?>>二等功</option>
        <option value="一等功" <?php if($bz['jlleibie']=="一等功"){?>selected<?php }?>>一等功</option>
      </select></td>
    <td width="132" align="right" class="infotitle">批准日期：</td>
    <td width="320"><?php echo form::date('in[pzdt]',date("Y-m-d",$bz['pzdt']),0,0,'false');?></td>    
    <td width="140" align="right" class="infotitle">批准机关：</td>
    <td width="434"><input type="text" id="pzjg" name="in[pzjg]" value="<?php echo $bz['pzjg']?>" class="infoinput" /></td>
    </tr>
  <tr>
    <td align="right" class="infotitle">批准文号：</td>
    <td width="289"><input type="text" id="pzwh" name="in[pzwh]" value="<?php echo $bz['pzwh']?>" class="infoinput" /></td>
  ...
  <tr>
    ...
    <td colspan="5"><div id='content_tip'></div><textarea name="in[shiji]" id="content" boxid="content"><?php echo $bz['shiji']?></textarea><script type="text/javascript" src="statics/js/ckeditor/ckeditor.js"></script><script type="text/javascript">
