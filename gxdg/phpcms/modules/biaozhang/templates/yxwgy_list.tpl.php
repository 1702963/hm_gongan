...
$tuiyi[2]="否";
		...
		$where=" isok=1 and mleixing='优秀网格员' ";
		$orders=" id desc ";
...
<input type="hidden" value="yxwgy" name="a">
<input type="hidden" value="<?php echo $status;?>" name="status">
<div class="explain-col"> 
  快速工具:   月度优秀网格员 &nbsp;                      
<a href="?m=biaozhang&c=biaozhang&a=addyxwgy"><input type="button" value="新增" class="button" name="dook"></a>  
		</div>
</form>
...
if(is_array($bzlist)){
	...
	<tr>
	  ...
	  ?></td>
      <td> 
        <a href="index.php?m=biaozhang&c=biaozhang&a=yxwgyshow&id=<?php echo $info['id']?>&status=<?php echo $status;?>">查看</a>
        
        &nbsp;<a href="index.php?m=biaozhang&c=biaozhang&a=edityxwgy&id=<?php echo $info['id']?>&status=<?php echo $status;?>">修改</a>
        
        &nbsp;<a href="index.php?m=biaozhang&c=biaozhang&a=yxwgyzuofei&dofei=1&ids=<?php echo $info['id']?>&status=<?php echo $status;?>" onclick="javascript:var r = confirm('确认作废当前记录吗？');if(!r){return false;}">作废</a>              
      </td>
	</tr>
   <?php
	$i++;}
