...
$tuiyi[2]="否";
		...
		$where=" isok=1 and mleixing='微笑之星' ";
		$orders=" id desc ";
...
<input type="hidden" value="wxzx" name="a">
<input type="hidden" value="<?php echo $status;?>" name="status">
<div class="explain-col"> 
  快速工具:   微笑之星 &nbsp;                      
<a href="?m=biaozhang&c=biaozhang&a=addwxzx"><input type="button" value="新增" class="button" name="dook"></a>  
		</div>
</form>
...
<table width="100%" cellspacing="0" class="kotable">
	...
	<tr>
      <th width='93'>序号</th>
      <th width="180">工作单位</th>
	  <th width='154'>姓名</th>
	  <th width="108">性别</th>
      <th width="248">身份证号</th>
	  <th width="177">月度</th>
      <th width="342">受奖励时单位</th>
      <th width="163">审核</th>
      <th width="389">操作</th>
	</tr>
    </thead>
...
if(is_array($bzlist)){
	...
	<tr>
	  ...
	  ?></td>
      <td>
        <a href="index.php?m=biaozhang&c=biaozhang&a=wxzxshow&id=<?php echo $info['id']?>&status=<?php echo $status;?>">查看</a>
        
        &nbsp;<a href="index.php?m=biaozhang&c=biaozhang&a=editwxzx&id=<?php echo $info['id']?>&status=<?php echo $status;?>">修改</a>
        
        &nbsp;<a href="index.php?m=biaozhang&c=biaozhang&a=wxzxzuofei&dofei=1&ids=<?php echo $info['id']?>&status=<?php echo $status;?>" onclick="javascript:var r = confirm('确认作废当前记录吗？');if(!r){return false;}">作废</a>         
      </td>
	</tr>
   <?php
	$i++;}
