...
$_POST['in']['ds']=$_ds;
$_POST['in']['tjdt']=$_tjdt;
$_POST['in']['mleixing']='民警奖励';
$_POST['in']['jldt']=strtotime($_POST['in']['jldt']);
$_POST['in']['pzdt']=strtotime($_POST['in']['pzdt']);
$_POST['in']['inuser']=param::get_cookie('admin_username');
$_POST['in']['inuserid']=$_SESSION['userid'];
...
showmessage('操作完成','index.php?m=biaozhang&c=biaozhang&a=mjjl');	
}
?>
...
<form action="?m=biaozhang&c=biaozhang&a=addmj" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  <tr>
    <td width="117" align="right" class="infotitle"><span>姓名：</span><input type="hidden" id="uid" name="in[uid]" value="" class="infoinput" /></td>
    <td width="246"><input type="text" id="xingming" name="in[xingming]" value="" class="infoinput" />
    <div id="inputlist">
        <ul>
        </ul>
    </div>       
    ...
    <td width="211"><input type="radio" class="rad" <?php if($sx['sex']=='男'){?>checked<?php }?>  name="in[sex]"  id="nan" value="男"/>男
        <input type="radio" class="rad"   name="in[sex]" <?php if($sx['sex']=='女'){?>checked<?php }?> value="女" id="nv"/>女</td>    
    <td width="152" align="right" class="infotitle">身份证号：</td>
    <td width="172" class="rb"><input type="text" name="in[sfz]" id="sfz" class="infoinput"  value=""/>
      
    </td>
    </tr>
  <tr>
    <td align="right" class="infotitle">政治面貌：</td>
    <td width="246"><input type="text" id="zzmm" name="in[zzmm]" value="" class="infoinput" /></td>
    <td width="100" align="right" class="infotitle">获奖励时间:</td>
    <td><?php echo form::date('in[jldt]',date("Y-m-d"),0,0,'false')?></td>
    <td align="right" class="infotitle">获奖励时职务：</td>
    <td><span class="rb">
      <input type="text" name="in[jlzhiwu]" id="jlzhiwu" class="infoinput"  value=""/>
    </span></td>
    </tr>
  <tr>
    <td align="right" class="infotitle">获奖励时单位：</td>
    <td width="246"><input type="text" name="in[jldanwei]" id="jldanwei" class="infoinput" value="" /></td>
    <td width="100" align="right" class="infotitle">现工作单位</td>
    <td width="211"><input name="in[danwei]" type="text" id="danwei" class="infoinput" value="" />
    <input type="hidden" id="dwid" name="in[dwid]" value="0" class="infoinput" />
    </td>
    <td width="152" align="right" class="infotitle">现任职务</td>
    <td class="rb"><input name="in[zhiwu]" type="text" id="zhiwu" class="infoinput" value="" /></td>
    </tr>
</table>
</div>
...
<div class="tabcon">
<div class="title" style="width:150px">获奖励情况</div>

<table cellpadding="0" cellspacing="0" class="baseinfo">
  <tr>
    <td width="118" align="right" class="infotitle"><span>奖励类别：</span></td>
    <td width="289"> <select name="in[jlleibie]" id="jlleibie" class="infoselect">
        <option value="嘉奖" <?php if($fujing['zzmm']=="嘉奖"){?>selected<?php }?>>嘉奖</option>
        <option value="三等功" <?php if($fujing['zzmm']=="三等功"){?>selected<?php }?>>三等功</option>
        <option value="二等功" <?php if($fujing['zzmm']=="二等功"){?>selected<?php }?>>二等功</option>
        <option value="一等功" <?php if($fujing['zzmm']=="一等功"){?>selected<?php }?>>一等功</option>
      </select></td>
    <td width="132" align="right" class="infotitle">批准日期：</td>
    <td width="320"><?php echo form::date('in[pzdt]',date("Y-m-d"),0,0,'false');?></td>    
    <td width="100" align="right" class="infotitle">批准机关：</td>
    <td width="474"><input type="text" id="pzjg" name="in[pzjg]" value="" class="infoinput" /></td>
    </tr>
  <tr>
    <td align="right" class="infotitle">批准文号：</td>
    <td width="289"><input type="text" id="pzwh" name="in[pzwh]" value="" class="infoinput" /></td>
    <td width="132" align="right" class="infotitle">证明材料上传：</td>
    ...
    <progress id="prob-zmups" value="0" max="100" style="display:none"></progress>
    </td>
    <td colspan="2" align="right" id="msgs-zmups">&nbsp;</td>
    </tr>
  <tr>
  ...
  <tr>
    <td align="right" class="infotitle">简要事迹：</td>
    <td colspan="5"><div id='content_tip'></div><textarea name="in[shiji]" id="content" boxid="content"></textarea><script type="text/javascript" src="statics/js/ckeditor/ckeditor.js"></script><script type="text/javascript">
...
['Source','-','Templates'],
  ...
  <tr>
    ...
    <td colspan="4"><input type="file" name="qtup" id="qtups" style="display:none" onchange="ufs('qtups')"/>&nbsp;<input type="button" value="上传" style="width:70px" onclick="onfiles('qtups')"/>&nbsp;
    <progress id="prob-qtups" value="0" max="100" style="display:none"></progress>
    </td>
    <td id="msgs-qtups">&nbsp;</td>
    </tr>
  <tr>
			...
			//console.log(ajax.responseText)	
             if(ajax.readyState == 4){ //if-1		
			  ...
			  if(obj.error==0){ //if-2
                 ...
                 liststr="<label style='width:90%; float:left;line-height:18px' id='list"+obj.aid+"'><input type='hidden' name='"+objname+"-url[]' value='"+obj.furl+"' /><input type='hidden' name='"+objname+"-name[]' value='"+obj.name+"' /><b id='rtitle"+obj.aid+"' >"+obj.name+"</b> &nbsp; <span><a href='javascript:;' onclick='dellist("+obj.aid+")'>删除</a>&nbsp;&nbsp;</span></label>";
				 //alert(liststr)
