...
showmessage('操作完成','index.php?m=biaozhang&c=biaozhang&a=wmbb');	
}
...
<!--
	...
	parent.document.getElementById('center_frame').src = '?m=admin&c=bumen&a=bumen_tree&pc_hash=<?php echo $_SESSION['pc_hash'];?>&mm=biaozhang&cc=biaozhang&aa=addwmbb&status=<?php echo $status;?>';
...
<form action="?m=biaozhang&c=biaozhang&a=addwmbb" method="POST" name="myform" id="myform">
...
<div class="tabcon">
<div class="title" style="width:150px">月度文明标兵</div>
...
<table cellpadding="0" cellspacing="0" class="baseinfo">
  ...
  <tr>
    ...
    <td colspan="6" id="uplist-zmups"></td>
  </tr>
  <tr>
...
['Source','-','Templates'],
  ...
  <tr>
    ...
    <td width="585"><input type="file" name="qtup" id="qtups" style="display:none" onchange="ufs('qtups')"/>&nbsp;<input type="button" value="上传" style="width:70px" onclick="onfiles('qtups')"/>&nbsp;
    <progress id="prob-qtups" value="0" max="100" style="display:none"></progress></td>
    <td width="730" id="msgs-qtups">&nbsp;</td>
    </tr>
  <tr>
    <td align="right" class="infotitle">已上传附件：</td>
    <td colspan="6" id="uplist-qtups"></td>
  </tr>
</table>
