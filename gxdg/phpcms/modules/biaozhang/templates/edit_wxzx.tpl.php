...
<form action="?m=biaozhang&c=biaozhang&a=editwxzx" method="POST" name="myform" id="myform">
...
<table cellpadding="0" cellspacing="0" class="baseinfo" align="center">
  ...
  <tr>
    ...
    <td width="246"><input type="radio" class="rad" <?php if($bz['shenhe']==1){?>checked<?php }?>  name="shenhe"  id="nan" value="1"/>通过
        ...
        &nbsp; <input type="submit" value="审核" style="width:70px;<?php if($_GET['a']!="editwxzx"){?>display:none;<?php }?>" name="doshenhe"/></td>
